...
**Docs map:** [`docs/README.md`](README.md) — 27-agent / nona layout. **Math/physics test framework (Rings 050–054):** [`docs/nona-03-manifest/T27-MATH-PHYSICS-TEST-FRAMEWORK-SPEC.md`](nona-03-manifest/T27-MATH-PHYSICS-TEST-FRAMEWORK-SPEC.md) — open **Ring 050** issue from template **Ring test framework**.  
