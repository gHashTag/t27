...
| 1–2 | EPIC-01 | **Audit** [`docs/RESEARCH_CLAIMS.md`](../RESEARCH_CLAIMS.md); close README ↔ registry gaps |
...
| Week | Epic | Key deliverable |
|------|------|-----------------|
| 5–6 | EPIC-04 | Complete [`docs/LANGUAGE_SPEC.md`](../LANGUAGE_SPEC.md); add backend contract |
...
1. **Audit** [`docs/RESEARCH_CLAIMS.md`](../RESEARCH_CLAIMS.md) vs README hero claims.  
