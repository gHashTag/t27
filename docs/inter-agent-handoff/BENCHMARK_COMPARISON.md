...
|-----------|--------|-----|----------------|----------------------|------------|
| Formal language spec | ✅ | ✅ | ✅ | **~partial** — [`docs/LANGUAGE_SPEC.md`](../LANGUAGE_SPEC.md) exists | EPIC-04 complete |
...
| Claims taxonomy | N/A | N/A | ✅ | **~** — [`docs/RESEARCH_CLAIMS.md`](../RESEARCH_CLAIMS.md) exists; audit ongoing | EPIC-01 |
