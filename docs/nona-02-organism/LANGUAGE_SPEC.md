...
| Topic | Location |
|-------|----------|
| Incremental bootstrap story | `docs/nona-01-foundation/SEED-RINGS.md`, `CANON.md` |
| ASCII / language policy | `architecture/ADR-004-language-policy.md`, `docs/nona-03-manifest/SOUL.md` |
| Numeric family | `docs/nona-02-organism/NUMERIC-STANDARD-001.md`, `specs/numeric/` |
...
State **soundness** theorems **only** for fragments that are actually proven or machine-checked; otherwise mark **conjecture** in `docs/nona-03-manifest/RESEARCH_CLAIMS.md`.
