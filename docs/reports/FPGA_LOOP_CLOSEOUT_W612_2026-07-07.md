# FPGA Wave Loop 612 Closeout Report

**Date:** 2026-07-07  
**Issue:** #1583  
**Branch:** `wave-loop-612`  
**Spec:** `specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.t27`

## What was delivered
Module-scope `[43][2]^6 Pt` non-power-of-two outer-dimension packed array-of-struct
...
- `pub fn make_grid(offset : u16) -> [43][2]^6 Pt`
- `pub const expected : [43][2]^6 Pt = make_grid(0);`
- `pub var dst : [43][2]^6 Pt = make_grid(0);`
- `test module_var_43x2p6_call_write`
- `bench module_bench_43x2p6_call_write`

## Sizing
- Outer dimension: 43 (non-power-of-two).
- Total elements: 43 × 2⁶ = 2,752.
- Packed vector width: 2,752 × 32 = 88,064 bits (≈0.084 MiBit).
...
| Gate | Command | Result |
|------|---------|--------|
| Parse | `./target/release/t27c parse specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.t27` | PASS |
| Icarus lowerable | `./target/release/t27c icarus-lowerable specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.t27` | lowerable |
| Icarus simulate | `./target/release/t27c icarus-simulate specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.t27` | PASS (silent exit 0) |
| cocotb reference | `./target/release/t27c icarus-cocotb specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.t27` | reference-model OK |
| Integration test | `cargo test -p t27c --test icarus_lowerable accepts_w612_bench_module_43x2p6_aos_var_call_write` | PASS |
| Seal | `./target/release/t27c seal --save specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.t27` | saved |
...
- New seal: `.trinity/seals/scratch_w612_bench_module_43x2p6_aos_var_call_write.json`.
- New empty baseline: `.trinity/icarus-baselines/specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.json`.

## Weak points investigated
1. **Outer dimension 43** — first time the ladder tests 43; no compiler or
...
4. **Simulator capacity** — 0.084 MiBit is comfortably inside Icarus/Yosys comfort.
...
- Icarus issue #1171 — large packed-vector elaboration freezes; W612 stays far below.
...
3. **Variant C — `[43][2]^6 Pt` conditional whole-array reassignment inside `if`, then indexed writes.**
   88,064-bit; tests control-flow guarded packed-reg reassignment (follow-up to W590/W591).

## Artifacts
- Spec: `specs/scratch/w612_bench_module_43x2p6_aos_var_call_write.t27`
- Plan: `.claude/plans/wave-loop-612.md`
- Report: `docs/reports/FPGA_LOOP_CLOSEOUT_W612_2026-07-07.md`
- Seal: `.trinity/seals/scratch_w612_bench_module_43x2p6_aos_var_call_write.json`
