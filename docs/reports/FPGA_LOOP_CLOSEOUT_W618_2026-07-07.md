# FPGA Wave Loop 618 Closeout Report

**Date:** 2026-07-07  
**Issue:** #1589  
**Branch:** `wave-loop-618`  
**Spec:** `specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.t27`

## What was delivered
Module-scope `[55][2]^6 Pt` non-power-of-two outer-dimension packed array-of-struct
...
- `pub fn make_grid(offset : u16) -> [55][2]^6 Pt`
- `pub const expected : [55][2]^6 Pt = make_grid(0);`
- `pub var dst : [55][2]^6 Pt = make_grid(0);`
- `test module_var_55x2p6_call_write`
- `bench module_bench_55x2p6_call_write`

## Sizing
- Outer dimension: 55 (non-power-of-two).
- Total elements: 55 × 2⁶ = 3,520.
- Packed vector width: 3,520 × 32 = 112,640 bits (≈0.107 MiBit).
...
| Gate | Command | Result |
|------|---------|--------|
| Parse | `./target/release/t27c parse specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.t27` | PASS |
| Icarus lowerable | `./target/release/t27c icarus-lowerable specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.t27` | lowerable |
| Icarus simulate | `./target/release/t27c icarus-simulate specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.t27` | PASS (silent exit 0) |
| cocotb reference | `./target/release/t27c icarus-cocotb specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.t27` | reference-model OK |
| Integration test | `cargo test -p t27c --test icarus_lowerable accepts_w618_bench_module_55x2p6_aos_var_call_write` | PASS |
| Seal | `./target/release/t27c seal --save specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.t27` | saved |
...
- New seal: `.trinity/seals/scratch_w618_bench_module_55x2p6_aos_var_call_write.json`.
- New empty baseline: `.trinity/icarus-baselines/specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.json`.

## Weak points investigated
1. **Outer dimension 55** — first time the ladder tests 55; no compiler or
...
4. **Simulator capacity** — 0.107 MiBit is comfortably inside Icarus/Yosys comfort.
...
- Icarus issue #1171 — large packed-vector elaboration freezes; W618 stays far below.
...
3. **Variant C — `[55][2]^6 Pt` conditional whole-array reassignment inside `if`, then indexed writes.**
   112,640-bit; tests control-flow guarded packed-reg reassignment (follow-up to W590/W591).

## Artifacts
- Spec: `specs/scratch/w618_bench_module_55x2p6_aos_var_call_write.t27`
- Plan: `.claude/plans/wave-loop-618.md`
- Report: `docs/reports/FPGA_LOOP_CLOSEOUT_W618_2026-07-07.md`
- Seal: `.trinity/seals/scratch_w618_bench_module_55x2p6_aos_var_call_write.json`
