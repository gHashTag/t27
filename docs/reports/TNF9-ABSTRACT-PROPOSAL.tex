...
rungs, three tasks, $30$ seeds --- a further $720$ runs. No step above nine levels
is significant on any task. The last significant rung is nine on UNSW-NB15 and
Fashion-MNIST and \emph{five} on MNIST: the ceiling is a constant, the rung is a
property of the task. The first step, three levels to five, is the largest
everywhere ($+0.547$, $+1.622$, $+0.511$\,pp).
