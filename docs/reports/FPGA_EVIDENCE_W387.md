...
Wave Loop 387 did not perform new hardware work. It inherited the successful bring-up from Wave Loop 385 and left the bitstream / SSOT state unchanged.
...
- W387 focused on proof-lattice expansion and 2D function-local array codegen; no FPGA evidence changed.
