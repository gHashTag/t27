...
\title{%
  ...
  \normalfont\includegraphics[width=0.20\textwidth]{trinity_logo.png}\\[10pt]
...
comparison, at $0.1797$\,MHz/LUT against $0.1631$ for the next entry and
$0.0295$ for \texttt{posit32}, with nine of the twenty-one ours. Formats needing
...
Twenty retractions of our own claims are marked in place below.
\end{abstract}
