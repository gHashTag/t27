# FPGA Loop Cooperation Variants — Wave 417 (2026-07-01)

**Next issue:** #1348 (to be created after W16 merge)  
**Next branch:** `wave-loop-417`  
**Anchor:** φ² + φ⁻² = 3 | TRINITY

Wave 416 delivered the **Variant C** formal-tooling fallback because the bench
was still blocked. For Wave 417 the bench status may change, so three
