# FPGA Wave Loop 622 Closeout Report

**Date:** 2026-07-07  
**Issue:** #1593  
**Branch:** `wave-loop-622`  
**Spec:** `specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.t27`

## What was delivered
Module-scope `[63][2]^6 Pt` non-power-of-two outer-dimension packed array-of-struct
...
- `pub fn make_grid(offset : u16) -> [63][2]^6 Pt`
- `pub const expected : [63][2]^6 Pt = make_grid(0);`
- `pub var dst : [63][2]^6 Pt = make_grid(0);`
- `test module_var_63x2p6_call_write`
- `bench module_bench_63x2p6_call_write`

## Sizing
- Outer dimension: 63 (non-power-of-two).
- Total elements: 63 × 2⁶ = 4,032.
- Packed vector width: 4,032 × 32 = 129,024 bits (≈0.123 MiBit).
...
| Gate | Command | Result |
|------|---------|--------|
| Parse | `./target/release/t27c parse specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.t27` | PASS |
| Icarus lowerable | `./target/release/t27c icarus-lowerable specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.t27` | lowerable |
| Icarus simulate | `./target/release/t27c icarus-simulate specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.t27` | PASS (silent exit 0) |
| cocotb reference | `./target/release/t27c icarus-cocotb specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.t27` | reference-model OK |
| Integration test | `cargo test -p t27c --test icarus_lowerable accepts_w622_bench_module_63x2p6_aos_var_call_write` | PASS |
| Seal | `./target/release/t27c seal --save specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.t27` | saved |
...
- New seal: `.trinity/seals/scratch_w622_bench_module_63x2p6_aos_var_call_write.json`.
- New empty baseline: `.trinity/icarus-baselines/specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.json`.

## Weak points investigated
1. **Outer dimension 63** — first time the ladder tests 63; no compiler or
...
4. **Simulator capacity** — 0.123 MiBit is comfortably inside Icarus/Yosys comfort.
...
- Icarus issue #1171 — large packed-vector elaboration freezes; W622 stays far below.
...
## Next Wave Loop 623 cooperation variants
...
3. **Variant C — `[63][2]^6 Pt` conditional whole-array reassignment inside `if`, then indexed writes.**
   129,024-bit; tests control-flow guarded packed-reg reassignment (follow-up to W590/W591).

## Artifacts
- Spec: `specs/scratch/w622_bench_module_63x2p6_aos_var_call_write.t27`
- Plan: `.claude/plans/wave-loop-622.md`
- Report: `docs/reports/FPGA_LOOP_CLOSEOUT_W622_2026-07-07.md`
- Seal: `.trinity/seals/scratch_w622_bench_module_63x2p6_aos_var_call_write.json`
