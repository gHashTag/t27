# FPGA Wave Loop 614 Closeout Report

**Date:** 2026-07-07  
**Issue:** #1585  
**Branch:** `wave-loop-614`  
**Spec:** `specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.t27`

## What was delivered
Module-scope `[47][2]^6 Pt` non-power-of-two outer-dimension packed array-of-struct
...
- `pub fn make_grid(offset : u16) -> [47][2]^6 Pt`
- `pub const expected : [47][2]^6 Pt = make_grid(0);`
- `pub var dst : [47][2]^6 Pt = make_grid(0);`
- `test module_var_47x2p6_call_write`
- `bench module_bench_47x2p6_call_write`

## Sizing
- Outer dimension: 47 (non-power-of-two).
- Total elements: 47 × 2⁶ = 3,008.
- Packed vector width: 3,008 × 32 = 96,256 bits (≈0.092 MiBit).
...
| Gate | Command | Result |
|------|---------|--------|
| Parse | `./target/release/t27c parse specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.t27` | PASS |
| Icarus lowerable | `./target/release/t27c icarus-lowerable specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.t27` | lowerable |
| Icarus simulate | `./target/release/t27c icarus-simulate specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.t27` | PASS (silent exit 0) |
| cocotb reference | `./target/release/t27c icarus-cocotb specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.t27` | reference-model OK |
| Integration test | `cargo test -p t27c --test icarus_lowerable accepts_w614_bench_module_47x2p6_aos_var_call_write` | PASS |
| Seal | `./target/release/t27c seal --save specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.t27` | saved |
...
- New seal: `.trinity/seals/scratch_w614_bench_module_47x2p6_aos_var_call_write.json`.
- New empty baseline: `.trinity/icarus-baselines/specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.json`.

## Weak points investigated
1. **Outer dimension 47** — first time the ladder tests 47; no compiler or
...
4. **Simulator capacity** — 0.092 MiBit is comfortably inside Icarus/Yosys comfort.
...
- Icarus issue #1171 — large packed-vector elaboration freezes; W614 stays far below.
...
3. **Variant C — `[47][2]^6 Pt` conditional whole-array reassignment inside `if`, then indexed writes.**
   96,256-bit; tests control-flow guarded packed-reg reassignment (follow-up to W590/W591).

## Artifacts
- Spec: `specs/scratch/w614_bench_module_47x2p6_aos_var_call_write.t27`
- Plan: `.claude/plans/wave-loop-614.md`
- Report: `docs/reports/FPGA_LOOP_CLOSEOUT_W614_2026-07-07.md`
- Seal: `.trinity/seals/scratch_w614_bench_module_47x2p6_aos_var_call_write.json`
