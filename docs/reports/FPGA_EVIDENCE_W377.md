...
Board flash is **blocked by missing DLC10 cable**, same as Waves 361–376. The QMTech Wukong V1 target and the in-tree Rust `dlc10` driver remain correct per `fpga/HARDWARE_SSOT.md`.
