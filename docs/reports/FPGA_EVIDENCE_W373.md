...
The Xilinx Platform Cable USB II (VID=0x03FD, PID=0x0008/0x000D) is not enumerated on the host. Without the cable, no JTAG IDCODE read, SRAM load, or reload is possible. This is the **same hardware-availability blocker** documented in W361–W372.
