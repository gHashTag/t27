...
| 2c | **With 4-bit activations the competitor becomes seed-dependent**: fp4 e2m1 at 13.93 % ± 6.30 (MNIST) and 84.58 % (Fashion); TNF4 at −0.26 / −0.55 pp, σ ≤ 0.58 | `lsq_2026-08-20.json` | this is an instability, not an 83-point effect — do not quote the mean alone |
