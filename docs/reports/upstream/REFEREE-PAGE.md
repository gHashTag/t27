...
| 1b | **What survives is recipe-insensitivity, with a measured mechanism.** TNF4 trains in **20/20** runs across 3 recipes and 3 tasks; `fp6 e3m2` in 12/20, `fp6 e2m3` in 6/20. Mechanism: **14.6 binades** at 6 bits against 8.8 and 5.9 | `stability_*_2026-08-20.json` | report the **failure rate**, never the mean — the competitor is bimodal (86.0, 86.8, 23.0, 87.3, 30.6) |
