...
Measured W856: it emits decades 8, 26, 80, 242; the paper's ladder table prints
2, 8, 24, 73, and 26, 80 and 242 occur ZERO times anywhere in tnf_paper.tex. The
difference is the source: this script reads the SPECIFICATION's field widths and
the paper now takes the ORACLE's throughout. The table's own caption records the
