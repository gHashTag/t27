...
**Authority:** `docs/T27-CONSTITUTION.md` (SSOT-MATH, LANG-EN), `docs/SOUL.md` Law #1, `architecture/ADR-004-language-policy.md`, `specs/queen/lotus.t27`  
...
Per **`docs/SEED-RINGS.md`** (Ghuloum incremental bootstrap):
...
| Path | Kind | Action |
|------|------|--------|
| `conformance/kepler_newton_tests.py` | Python verdict | Replace with `.t27` + `tri verdict` per `docs/TZ-T27-001-NO-PYTHON-CRITICAL-PATH.md` |
...
| `conformance/*.json` | Prefer **generated from specs** per `docs/TDD-CONTRACT.md` |

---

## 4. Agent instructions (enforcement they cannot ignore)

1. **Read first:** `CLAUDE.md` → `docs/T27-CONSTITUTION.md` → **this file** → `docs/SEED-RINGS.md`.
