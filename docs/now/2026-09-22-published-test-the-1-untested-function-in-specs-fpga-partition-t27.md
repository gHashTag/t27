# NOW -- Test the 1 untested function in specs/fpga/partition.t27 (published 2026-09-22)

## A bee's work on #4447, published from `queen-4447` (Closes #4447)

- The branch changes 2 file(s): `docs/now/2026-09-20-published-test-the-1-untested-function-in-specs-fpga-partition-t27.md`, `specs/fpga/partition.t27`.
- `git diff --stat origin/master...queen-4447` reads: 2 files changed, 21 insertions(+)
