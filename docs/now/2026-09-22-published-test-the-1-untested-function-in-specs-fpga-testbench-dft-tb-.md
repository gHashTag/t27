# NOW -- Test the 1 untested function in specs/fpga/testbench/dft_tb.t27 (published 2026-09-22)

## A bee's work on #4452, published from `queen-4452` (Closes #4452)

- The branch changes 1 file(s): `specs/fpga/testbench/dft_tb.t27`.
- `git diff --stat origin/master...queen-4452` reads: 1 file changed, 5 insertions(+)
