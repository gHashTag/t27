# NOW -- Test the 1 untested function in specs/fpga/top_level.t27 (published 2026-09-24)

## A bee's work on #4700, published from `queen-4700` (Closes #4700)

- The branch changes 1 file(s): `specs/fpga/top_level.t27`.
- `git diff --stat origin/master...queen-4700` reads: 1 file changed, 9 insertions(+)
