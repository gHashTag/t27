# NOW -- Test the 1 untested function in specs/fpga/hw_types.t27 (published 2026-09-20)

## A bee's work on #4337, published from `queen-4337` (Closes #4337)

- The branch changes 2 file(s): `docs/now/2026-09-20-published-test-the-1-untested-function-in-specs-fpga-hw-types-t27.md`, `specs/fpga/hw_types.t27`.
- `git diff --stat origin/master...queen-4337` reads: 2 files changed, 17 insertions(+)
