# NOW -- The &mut/& split makes a same-array mem_copy unrepresentable in Rust, where C expresses it (published 2026-09-26)

## A bee's work on #4825, published from `queen-4825` (Closes #4825)

- The branch changes 1 file(s): `specs/isa/ternary_memory.t27`.
- `git diff --stat origin/master...queen-4825` reads: 1 file changed, 1 insertion(+)
