# NOW -- suite: parse phase is superlinear, making `t27c suite` unrunnable on specs/scratch (12.4M lines) (published 2026-09-24)

## A bee's work on #1781, published from `queen-1781` (Closes #1781)

- The branch changes 1 file(s): `specs/igla/race/backend.t27`.
- `git diff --stat origin/master...queen-1781` reads: 1 file changed, 1 insertion(+), 1 deletion(-)
