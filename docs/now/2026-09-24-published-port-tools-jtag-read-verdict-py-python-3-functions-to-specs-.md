# NOW -- Port tools/jtag/read_verdict.py (Python, 3 functions) to specs/port/tools/jtag/read_verdict.t27 (published 2026-09-24)

## A bee's work on #4675, published from `queen-4675` (Closes #4675)

- The branch changes 1 file(s): `specs/port/tools/jtag/read_verdict.t27`.
- `git diff --stat origin/master...queen-4675` reads: 1 file changed, 44 insertions(+)
