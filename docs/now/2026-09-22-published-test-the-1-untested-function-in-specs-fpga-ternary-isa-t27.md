# NOW -- Test the 1 untested function in specs/fpga/ternary_isa.t27 (published 2026-09-22)

## A bee's work on #4450, published from `queen-4450` (Closes #4450)

- The branch changes 2 file(s): `docs/now/2026-09-20-published-test-the-1-untested-function-in-specs-fpga-ternary-isa-t27.md`, `specs/fpga/ternary_isa.t27`.
- `git diff --stat origin/master...queen-4450` reads: 2 files changed, 27 insertions(+)
