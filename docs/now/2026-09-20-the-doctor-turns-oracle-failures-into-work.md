...
- The command in the issue is quoted as `t27c`, never as the path on the machine that measured it - that mistake put an absolute `.../t27/target/release/t27c` from one laptop into 137 open issues and made every one of them unrunnable in a container.
