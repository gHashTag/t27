# NOW -- Test the 1 untested function in specs/fpga/partition.t27 (published 2026-09-20)

## A bee's work on #4447, published from `queen-4447` (Closes #4447)

- The branch changes 1 file(s): `specs/fpga/partition.t27`.
- `git diff --stat origin/master...queen-4447` reads: 1 file changed, 10 insertions(+)
