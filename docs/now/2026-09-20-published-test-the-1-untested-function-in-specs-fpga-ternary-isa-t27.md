# NOW -- Test the 1 untested function in specs/fpga/ternary_isa.t27 (published 2026-09-20)

## A bee's work on #4450, published from `queen-4450` (Closes #4450)

- The branch changes 1 file(s): `specs/fpga/ternary_isa.t27`.
- `git diff --stat origin/master...queen-4450` reads: 1 file changed, 16 insertions(+)
