# NOW -- An inline # comment on a struct field deletes the next field, in every backend, and both stages accept it (published 2026-09-23)

## A bee's work on #3243, published from `queen-3243` (Closes #3243)

- The branch changes 1 file(s): `specs/tri/pipeline/pipeline_parallel.t27`.
- `git diff --stat origin/master...queen-3243` reads: 1 file changed, 8 insertions(+), 8 deletions(-)
