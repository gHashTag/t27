...
Roadmap (rings, when `.t27` tests execute under Rust vs t27): **`docs/nona-03-manifest/T27-BOOTSTRAP-TESTING-PLAN.md`**. Testing oracles and metamorphic/differential strategy: **`docs/nona-03-manifest/GOLDEN-CHAIN-TESTING-ATLAS.md`**.
