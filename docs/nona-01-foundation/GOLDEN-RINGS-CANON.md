...
**Status:** Active  
**Companion:** `docs/nona-01-foundation/SEED-RINGS.md`, `bootstrap/stage0/FROZEN_HASH`, `docs/T27-CONSTITUTION.md`, `docs/nona-03-manifest/T27-BOOTSTRAP-TESTING-PLAN.md`, `docs/nona-03-manifest/GOLDEN-CHAIN-TESTING-ATLAS.md`  
...
| **`docs/nona-01-foundation/SEED-RINGS.md` + this file** | Process gold — how rings and micro-iterations work. |
| **`docs/T27-CONSTITUTION.md` + `docs/nona-03-manifest/SOUL.md` Law #1** | Policy gold — language and SSOT. |
...
- Numeric primary format: **`docs/nona-02-organism/NUMERIC-STANDARD-001.md`**.  
- Language purge procedure: **`docs/nona-01-foundation/QUEEN-LOTUS-SEED-LANGUAGE-PURGE.md`** (Lotus phases).  
