...
**Canon:** `docs/NUMERIC-STANDARD-001.md` — **GF16 is PRIMARY** for inference; other GoldenFloat widths are **family members**, not substitutes for “IEEE f32/f64 everywhere.”  
**Tag legend:**
