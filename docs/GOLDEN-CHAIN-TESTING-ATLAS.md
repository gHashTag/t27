...
**Companion:** **`docs/T27-BOOTSTRAP-TESTING-PLAN.md`** (rings, issue spine, “when tests live in `.t27`”)
...
- **CODATA / published constants:** compare documented φ-related or physical ratios to tabulated values *with explicit uncertainty* where the spec demands it — see **`docs/NUMERIC-STANDARD-001.md`** and domain specs under `specs/`.
...
For **Trinity brain** (`specs/brain/` SSOT, per **`docs/TRINITY-BRAIN-NEUROANATOMY-TZ.md`**):
...
Charter-level: “brain reasonableness” should be **falsifiable** (see **`docs/MULTI-MODEL-TRUST-CHAIN-ANALYSIS.md`**).
...
When opening issues, use the **Bootstrap testing** template (recommended fields mirror **`docs/T27-BOOTSTRAP-TESTING-PLAN.md`** § Issue template).

---

## 6) Sprint spine (where to look)

Concrete **ring / issue numbering** and exit criteria: **`docs/T27-BOOTSTRAP-TESTING-PLAN.md`**.  
Ring freeze mechanics and oak layers: **`docs/SEED-RINGS.md`**, **`docs/GOLDEN-RINGS-CANON.md`**.
