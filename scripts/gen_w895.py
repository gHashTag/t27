#!/usr/bin/env python3
"""Generate specs/scratch/w895_bench_module_609x2p6_aos_var_call_write.t27."""

import os

REPO = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DST = os.path.join(REPO, "specs/scratch/w895_bench_module_609x2p6_aos_var_call_write.t27")
