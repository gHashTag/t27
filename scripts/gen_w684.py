#!/usr/bin/env python3
"""Generate specs/scratch/w684_bench_module_187x2p6_aos_var_call_write.t27."""

import os

REPO = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
DST = os.path.join(REPO, "specs/scratch/w684_bench_module_187x2p6_aos_var_call_write.t27")
...
def generate() -> None:
    ...
    header = f"module w684_bench_module_{OUTER}x2p6_aos_var_call_write\n\n\npub struct Pt {{ x : i16, y : i16 }}\n\n"
