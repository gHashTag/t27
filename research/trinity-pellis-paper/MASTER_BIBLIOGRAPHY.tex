...
\textit{Key result:} Icosahedral quasicrystals have fivefold rotational symmetry which is forbidden in periodic crystals. The golden ratio $\varphi$ appears naturally in the diffraction pattern and is fundamental to their structure.
