...
% A Comprehensive Catalogue with 42 Formulas Across 9 Physics Sectors
...
\footnote{Machine-verified proof base (Coq~8.19,
\texttt{coq-interval}~$\ge$~4.8.0, 28~theorems across
6~physics sectors) is available at~\cite{trinity2024}.
...
scripts, and Coq proof base (28~theorems,
\texttt{coq-interval}-certified bounds) are
