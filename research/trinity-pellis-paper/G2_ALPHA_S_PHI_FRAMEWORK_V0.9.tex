...
\begin{enumerate}
  ...
  \item \textbf{N04: $\delta_{CP}^{\mathrm{PMNS}} = 8\pi^3/(9e^2) = 129.1^\circ$} ---
...
\textbf{42} VERIFIED formulas across \textbf{10} physics sectors with $\Delta < 0.1\%$ precision.
...
statistical significance ($p = 1.47 \times 10^{-5^3} = 1.47 \times 10^{-353}$) against the look-elsewhere effect.
...
\end{equation}
Thus $\Delta \approx 6.65\%$, not the $3.89\%$ quoted in Section 5. This analysis
