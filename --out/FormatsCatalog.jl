...
const FORMATS = Format[
    ...
    Format("takum8", "takum8", UInt32(8), UInt32(1), UInt32(0), UInt32(0), Int64(0), -1.0, "u8", "PositUnumIII", "Verified", "Hunhold 2024 (tapered-precision)", "IEEE-754 backward-compatible tapered", "ally", "Hunhold 2024 (arXiv:2404.18603)"),
    Format("takum16", "takum16", UInt32(16), UInt32(1), UInt32(0), UInt32(0), Int64(0), -1.0, "u16", "PositUnumIII", "Verified", "Hunhold 2024", "single-rule ladder counterexample", "ally", "Hunhold 2024 (arXiv:2404.18603)"),
