...
/// via sigrok-cli, or parse a CSV export to estimate frequency / duty cycle.
fn measure_cclk(
    csv: Option<&PathBuf>,
    live: bool,
    driver: &str,
    ...
    let (freq_hz, duty_pct, source) = if live {
    ...
    if validate {
        ...
        println!(
            "  Validation: OK (CCLK within N25Q128 standard-read spec, {:.1}x below {:.3} MHz limit)",
