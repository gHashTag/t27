...
def generate_bayesian_question(num: int) -> Dict[str, Any]:
    ...
    scenarios = [
        ...
        {
            "setup": "A family has two children. You see one of them, a boy. What's the probability the other is also a boy?",
...
def main():
    ...
    print(f"Total questions: {sum(QUESTION_TYPES.values()) + sum(ADVERSARIAL_TYPES.values())}")
