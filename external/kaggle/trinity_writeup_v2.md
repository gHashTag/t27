...
|-------|-----------|-------------------|----------------|
| THLP (Hippocampal Learning Probe) | Hippocampus/Entorhinal Cortex | Pattern learning, belief update, rule induction | ~1,150 |
| TTM (Trinity Thinking Metacognition) | PCC/dlPFC | Confidence calibration, error detection, meta-learning | 600 |
| TSCP (Social Cognition Probe) | TPJ/mPFC/OFC | Theory of Mind, pragmatic inference, social norms | 500 |
| TEFB (Executive Function Battery) | dlPFC/ACC/OFC | Multi-step planning, working memory, cognitive flexibility | ~1,800 |
| TAGP (Attentional Gateway Probe) | Parietal/Thalamus/FEF | Selective filtering, sustained attention, attention shifting | ~2,200 |
...
4. Trinity S3AI (2026). "Trinity Cognitive Probes v5: Deduplicated Multi-Track AGI Benchmark." *Kaggle Datasets*. https://www.kaggle.com/datasets/playra/

---

**Word Count**: 899 (well under 1,500 limit)
