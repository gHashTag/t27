...
$F_{\max}\approx 2050\cdot\mathrm{LUT}^{-0.592}$ ($R^2=0.92$) across a
$28\times$ span of area, which makes MHz per LUT a proxy for size rather than a
...
Twenty-two retractions of our own claims were made during the work, and are
