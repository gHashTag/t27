...
const FORMATS = Format[
    ...
    Format("gf24", "GF24", UInt32(24), UInt32(1), UInt32(9), UInt32(14), Int64(255), 0.025, "u32", "GoldenFloat", "Experimental", "this work; L15 PHI_BIAS=1364", "server inference", "self", "specs/numeric/gf24.t27 (spec only)"),
    ...
    Format("gf6", "GF6 (predicted)", UInt32(6), UInt32(1), UInt32(2), UInt32(3), Int64(1), 0.05, "u8_packed", "GoldenFloat", "Experimental", "this work; e=round(5/phi^2)=2, fills FP6 gap", "OPEN R&D: bridge GF4-GF8; FP6 E2M3 hint", "experimental", "section12.5"),
    Format("gf128", "GF128 (predicted)", UInt32(128), UInt32(1), UInt32(48), UInt32(79), Int64(0), 0.008, "u128", "GoldenFloat", "Experimental", "this work; e=round(127/phi^2)=48 (Open: bias TBD)", "OPEN R&D: phi-aligned binary128 alternative", "experimental", "section12.5"),
    Format("gf256", "GF256 (predicted)", UInt32(256), UInt32(1), UInt32(97), UInt32(158), Int64(0), 0.005, "u256_software", "GoldenFloat", "Experimental", "this work; e=round(255/phi^2)=97 (Open: bias ~2^71 unconfirmed)", "OPEN R&D: phi-aligned binary256 alternative", "experimental", "section12.5; bias Open per skill"),
