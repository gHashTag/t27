...
formats =
  ...
  , Format "gf24" "GF24" 24 1 9 14 255 (0.025) "u32" "GoldenFloat" "Experimental" "this work; L15 PHI_BIAS=1364" "server inference" "self" "specs/numeric/gf24.t27 (spec only)"
  ...
  , Format "gf6" "GF6 (predicted)" 6 1 2 3 1 (0.05) "u8_packed" "GoldenFloat" "Experimental" "this work; e=round(5/phi^2)=2, fills FP6 gap" "OPEN R&D: bridge GF4-GF8; FP6 E2M3 hint" "experimental" "section12.5"
  , Format "gf128" "GF128 (predicted)" 128 1 48 79 0 (0.008) "u128" "GoldenFloat" "Experimental" "this work; e=round(127/phi^2)=48 (Open: bias TBD)" "OPEN R&D: phi-aligned binary128 alternative" "experimental" "section12.5"
  , Format "gf256" "GF256 (predicted)" 256 1 97 158 0 (0.005) "u256_software" "GoldenFloat" "Experimental" "this work; e=round(255/phi^2)=97 (Open: bias ~2^71 unconfirmed)" "OPEN R&D: phi-aligned binary256 alternative" "experimental" "section12.5; bias Open per skill"
