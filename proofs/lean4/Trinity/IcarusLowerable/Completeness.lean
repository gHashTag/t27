...
def api_sdk_contract_env : Env := {
  structs := [("Hypervector", [("data", (.struct "HybridBigInt")), ("label", (.struct "[]constu8=null")), ("init", (.u32)), ("dim", (.struct "usize)->HypervectorCreatezerohypervectorfnrandom(dim:usize")), ("seed", (.struct "u64)->HypervectorCreaterandomhypervectorfnrandomLabeled(dim:usize")), ("seed", (.u64)), ("label", (.struct "[]constu8)->HypervectorCreaterandomhypervectorwithlabelfnfromRaw(raw:HybridBigInt)->HypervectorCreatehypervectorfromexistingHybridBigInt"))])],
  constructors := [],
  enums := [],
  imports := [],
  hostOnly := [],
...
def base_debounce_env : Env := {
  structs := [("SacredPhysics::TrinityVerification", [("phi_value", (.struct "f64")), ("phi_sq_value", (.struct "f64")), ("phi_inv_sq", (.struct "f64")), ("trinity_value", (.struct "f64")), ("target", (.struct "f64")), ("absolute_error", (.struct "f64")), ("relative_error", (.struct "f64")), ("passes", (.bool)), ("tolerance", (.struct "f64"))]), ("SacredPhysics::SacredPhysicsReport", [("trinity_value", (.struct "f64")), ("trinity_ok", (.bool)), ("gamma_value", (.struct "f64")), ("c_threshold", (.struct "f64")), ("t_present_ms", (.struct "f64")), ("g_pred", (.struct "f64")), ("g_measured", (.struct "f64")), ("g_rel_error", (.struct "f64")), ("g_ok", (.bool)), ("omega_pred", (.struct "f64")), ("omega_measured", (.struct "f64")), ("omega_rel_error", (.struct "f64")), ("omega_ok", (.bool)), ("f_gamma_pred", (.struct "f64"))])],
  constructors := [],
  enums := [],
...
def base_ternary_encoding_env : Env := {
  structs := [("EncodingInfo", [("encoding_type", (.u8)), ("trits_used", (.struct "usize")), ("byte_value", (.u8)), ("is_valid", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
...
def base_ternary_memory_env : Env := {
  structs := [("TritCell", [("value", (.i32)), ("state", (.u8)), ("last_access", (.u64)), ("access_count", (.u32))]), ("TernaryWord", [("trits", (.struct "[TRIT_CAPACITY]TritCell")), ("state", (.u8)), ("checksum", (.u32))]), ("TernaryMemoryBank", [("words", (.struct "[WORD_CAPACITY]TernaryWord")), ("allocated", (.struct "usize")), ("total_accesses", (.u64))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types"))],
  hostOnly := [],
...
def benchmarks_bench_nn_env : Env := {
  structs := [("", [("data", (.struct "[]f32")), ("count", (.struct "usize")), ("rows", (.struct "usize")), ("cols", (.struct "usize"))])],
  constructors := [],
  enums := [],
  imports := [],
  hostOnly := [],
...
def cloud_railway_deploy_env : Env := {
  structs := [("SacredPhysics::TrinityVerification", [("phi_value", (.struct "f64")), ("phi_sq_value", (.struct "f64")), ("phi_inv_sq", (.struct "f64")), ("trinity_value", (.struct "f64")), ("target", (.struct "f64")), ("absolute_error", (.struct "f64")), ("relative_error", (.struct "f64")), ("passes", (.bool)), ("tolerance", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("SacredPhysics::SacredPhysicsReport", [("trinity_value", (.struct "f64")), ("trinity_ok", (.bool)), ("gamma_value", (.struct "f64")), ("c_threshold", (.struct "f64")), ("t_present_ms", (.struct "f64")), ("g_pred", (.struct "f64")), ("g_measured", (.struct "f64")), ("g_rel_error", (.struct "f64")), ("g_ok", (.bool)), ("omega_pred", (.struct "f64")), ("omega_measured", (.struct "f64")), ("omega_rel_error", (.struct "f64")), ("omega_ok", (.bool)), ("f_gamma_pred", (.struct "f64"))])],
  constructors := [],
  enums := [],
...
def compiler_mod_structure_env : Env := {
  structs := [("SacredPhysics::SacredPhysicsReport", [("trinity_value", (.struct "f64")), ("trinity_ok", (.bool)), ("gamma_value", (.struct "f64")), ("c_threshold", (.struct "f64")), ("t_present_ms", (.struct "f64")), ("g_pred", (.struct "f64")), ("g_measured", (.struct "f64")), ("g_rel_error", (.struct "f64")), ("g_ok", (.bool)), ("omega_pred", (.struct "f64")), ("omega_measured", (.struct "f64")), ("omega_rel_error", (.struct "f64")), ("omega_ok", (.bool)), ("f_gamma_pred", (.struct "f64"))]), ("SacredPhysics::TrinityVerification", [("phi_value", (.struct "f64")), ("phi_sq_value", (.struct "f64")), ("phi_inv_sq", (.struct "f64")), ("trinity_value", (.struct "f64")), ("target", (.struct "f64")), ("absolute_error", (.struct "f64")), ("relative_error", (.struct "f64")), ("passes", (.bool)), ("tolerance", (.struct "f64"))])],
  constructors := [],
  enums := [],
  imports := [("", ("math::sacred_physics", ""))],
  hostOnly := [],
...
def config_load_env : Env := {
  structs := [("TriConfig::ConfigValue", [("string", (.struct "[]constu8")), ("number", (.struct "f64")), ("boolean", (.bool)), ("is_null", (.bool))]), ("TriConfig::Config", [("entries", (.struct "[]ConfigEntry")), ("error", (.struct "[]constu8"))]), ("TriConfig::ConfigEntry", [("key", (.struct "[]constu8")), ("value", (.struct "ConfigValue"))])],
  constructors := [],
  enums := [],
...
def demos_simple_test_env : Env := {
  structs := [("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types"))],
  hostOnly := [],
...
def fpga_bootrom_env : Env := {
  structs := [("BootStage", [("name", (.struct "&str")), ("index", (.u32)), ("size_bytes", (.u32)), ("entry_addr", (.u32))]), ("BootConfig", [("name", (.struct "&str")), ("rom_base", (.u32)), ("rom_size", (.u32)), ("has_integrity_check", (.bool)), ("has_chain_loader", (.bool))])],
...
def fpga_cts_env : Env := {
  structs := [("PllConfig", [("name", (.struct "&str")), ("input_mhz", (.u32)), ("output_mhz", (.u32)), ("multiply", (.u32)), ("divide", (.u32)), ("jitter_ps", (.u32))]), ("ClockBuffer", [("name", (.struct "&str")), ("delay_ps", (.u32)), ("fanout", (.u32))]), ("ClockTree", [("root", (.struct "&str")), ("num_levels", (.u32)), ("total_buffers", (.u32)), ("max_skew_ps", (.u32))]), ("CtsReport", [("num_clocks", (.u32)), ("num_plls", (.u32)), ("total_buffers", (.u32)), ("worst_skew_ps", (.u32)), ("worst_latency_ps", (.u32)), ("has_violations", (.bool))])],
...
def fpga_dft_env : Env := {
  structs := [("ScanChain", [("name", (.struct "&str")), ("num_regs", (.u32)), ("chain_length_bits", (.u32))]), ("BistCtrl", [("name", (.struct "&str")), ("kind", (.i8)), ("patterns", (.u32)), ("pass_threshold", (.u32))]), ("JtagTap", [("name", (.struct "&str")), ("ir_width", (.u32)), ("num_dr_regs", (.u32)), ("bypass_code", (.u32)), ("idcode", (.u32))]), ("TestCoverage", [("scan_coverage", (.u32)), ("bist_coverage", (.u32)), ("atpg_coverage", (.u32)), ("total_coverage", (.u32))])],
...
def fpga_hw_types_env : Env := {
  structs := [("HwType", [("tag", (.i8)), ("width", (.u32)), ("is_signed_flag", (.bool)), ("is_clock_flag", (.bool)), ("is_reset_flag", (.bool)), ("elem_tag", (.i8)), ("vec_len", (.u32)), ("field_count", (.u32))])],
...
def fpga_mac_env : Env := {
  structs := [("MACUnit", [("accumulator", (.i32)), ("status", (.u8)), ("pipeline", (.struct "[PIPELINE_STAGES]TernaryWord"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("tritype-ops::AddResult", [("result", (.struct "Trit")), ("carry_out", (.struct "Trit"))])],
  constructors := [],
  enums := [],
...
def fpga_power_env : Env := {
  structs := [("PowerDomain", [("name", (.struct "&str")), ("voltage_mv", (.u32)), ("clock_mhz", (.u32)), ("toggle_rate", (.u32))]), ("PowerEstimate", [("dynamic_mw", (.u32)), ("static_mw", (.u32)), ("total_mw", (.u32)), ("lut_power_uw", (.u32)), ("ff_power_uw", (.u32)), ("bram_power_uw", (.u32)), ("dsp_power_uw", (.u32))])],
...
def fpga_spi_env : Env := {
  structs := [("SPI_Master_Unit", [("state", (.u8)), ("tx_state", (.u8)), ("cs_asserted", (.bool)), ("busy", (.bool)), ("prescaler", (.u8)), ("data_width", (.u8)), ("cs_mode", (.u8)), ("tx_data", (.u32)), ("rx_data", (.u32)), ("bit_count", (.u8)), ("bit_counter", (.u32)), ("cs_assert_cnt", (.u32)), ("cs_deassert_cnt", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types"))],
  hostOnly := [],
...
def fpga_top_level_env : Env := {
  structs := [("SystemState", [("mac_ready", (.bool)), ("uart_ready", (.bool)), ("processing", (.bool)), ("error", (.bool))]), ("tritype-ops::AddResult", [("result", (.struct "Trit")), ("carry_out", (.struct "Trit"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
...
def fpga_uart_env : Env := {
  structs := [("UARTState", [("tx_data", (.u8)), ("tx_valid", (.bool)), ("tx_ready", (.bool)), ("rx_data", (.u8)), ("rx_valid", (.bool)), ("rx_error", (.bool)), ("bit_counter", (.u8)), ("status", (.u8))]), ("UARTConfig", [("baud_divisor", (.u32)), ("parity_enable", (.bool)), ("stop_bits", (.u8)), ("fifo_enable", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("tritype-ops::AddResult", [("result", (.struct "Trit")), ("carry_out", (.struct "Trit"))])],
  constructors := [],
  enums := [],
...
def fpga_verification_build_verify_env : Env := {
  structs := [("ModuleReport", [("name", (.struct "str")), ("verilog_lines", (.u32)), ("has_tests", (.bool)), ("has_invariants", (.bool)), ("has_bench", (.bool))]), ("BuildResult", [("total_specs", (.u32)), ("parse_ok", (.u32)), ("typecheck_ok", (.u32)), ("gen_zig_ok", (.u32)), ("gen_verilog_ok", (.u32)), ("gen_c_ok", (.u32)), ("gen_rust_ok", (.u32)), ("seal_ok", (.u32)), ("failures", (.u32))])],
  constructors := [],
  enums := [],
  imports := [],
  hostOnly := [],
...
def fpga_verification_build_verify_module : Module := {
  ...
  functions := [{ name := "check_build_clean", params := [("result", (.struct "BuildResult"))], ret := (some (.bool)), body := [.return_ (some (.binop "==" (.fieldAccess (.identifier "result") "failures") (.intLit (0))))] }, { name := "coverage_percent", params := [("ok", (.u32)), ("total", (.u32))], ret := (some (.u32)), body := [] }],
...
def graph_knowledge_graph_env : Env := {
  structs := [("Entity", [("name", (.struct "[]constu8")), ("vector", (.struct "PackedBigInt")), ("id", (.u32))]), ("Relation", [("name", (.struct "[]constu8")), ("vector", (.struct "PackedBigInt")), ("id", (.u32))]), ("Triple", [("subject_id", (.u32)), ("predicate_id", (.u32)), ("object_id", (.u32)), ("vector", (.struct "PackedBigInt"))]), ("KnowledgeGraph", [("entities", (.struct "[MAX_ENTITIES]Entity")), ("entity_count", (.u32)), ("relations", (.struct "[MAX_ENTITIES]Relation")), ("relation_count", (.u32)), ("triples", (.struct "[MAX_TRIPLES]Triple")), ("triple_count", (.u32)), ("graph_vector", (.struct "PackedBigInt"))]), ("", [("entity", (.struct "*Entity")), ("similarity", (.struct "f64"))]), ("", [("entities", (.u32)), ("relations", (.u32)), ("triples", (.u32))]), ("PackedTrit::ArithResult", [("value", (.struct "PackedBigInt")), ("overflow", (.bool))]), ("PackedTrit::PackedBigInt", [("data", (.struct "[]u8")), ("sign", (.i8)), ("magnitude", (.u16))]), ("HybridArithmetic::Vec32i16", [("data", (.array 16 (.i16)))]), ("HybridArithmetic::HybridBigInt", [("packed_data", (.struct "[]u8")), ("unpacked_data", (.struct "[]i8")), ("mode", (.struct "StorageMode")), ("sign", (.i8)), ("trit_count", (.u16))]), ("PackedTrit::PackResult", [("bytes", (.struct "[]u8")), ("count", (.u16)), ("valid", (.bool))]), ("HybridArithmetic::Vec32i8", [("data", (.array 32 (.i8)))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("PackedTrit::UnpackResult", [("trits", (.struct "[]i8")), ("count", (.u16)), ("valid", (.bool))])],
  constructors := [],
  enums := [],
...
def hslm_forward_pass_env : Env := {
  structs := [("RoleVector", [("role_id", (.u8)), ("name", (.struct "[]constu8")), ("vector", (.struct "PackedBigInt"))]), ("HyperVector", [("data", (.struct "[]PackedBigInt")), ("dim", (.struct "usize"))]), ("ForwardOutput", [("output", (.struct "PackedBigInt")), ("loss", (.struct "f64"))]), ("PackedTrit::PackedBigInt", [("data", (.struct "[]u8")), ("sign", (.i8)), ("magnitude", (.u16))]), ("PackedTrit::ArithResult", [("value", (.struct "PackedBigInt")), ("overflow", (.bool))]), ("PackedTrit::UnpackResult", [("trits", (.struct "[]i8")), ("count", (.u16)), ("valid", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("PackedTrit::PackResult", [("bytes", (.struct "[]u8")), ("count", (.u16)), ("valid", (.bool))])],
  constructors := [],
  enums := [],
...
def igla_race_adder_tree_env : Env := {
  structs := [("Vec8", [("v0", (.i32)), ("v1", (.i32)), ("v2", (.i32)), ("v3", (.i32)), ("v4", (.i32)), ("v5", (.i32)), ("v6", (.i32)), ("v7", (.i32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types"))],
  hostOnly := [],
...
def igla_race_systolic_ternary_env : Env := {
  structs := [("SystolicTernaryPE", [("a_reg", (.i8)), ("psum_reg", (.i16))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("igla-race-ternary-mac::TernaryWeight", [("code", (.u8))])],
...
def igla_race_ternary_inference_env : Env := {
  structs := [("TernaryModel", [("weights", (.struct "[]TernaryWeight"))]), ("InferenceInput", [("activations", (.struct "[]i8"))]), ("InferenceResult", [("outputs", (.struct "[]i8"))]), ("igla-race-bram-weights::WeightBank", [("depth", (.u32)), ("width", (.u32)), ("data", (.struct "[]i16"))]), ("igla-race-ternary-gemm::TernaryGemmResult", [("data", (.struct "[]i8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("igla-race-bram-weights::WeightAddr", [("row", (.u32)), ("col", (.u32))]), ("igla-race-systolic-ternary::SystolicTernaryPE", [("a_reg", (.i8)), ("psum_reg", (.i16))]), ("igla-race-ternary-mac::TernaryWeight", [("code", (.u8))])],
...
def igla_race_ternary_mac_env : Env := {
  structs := [("TernaryWeight", [("code", (.u8))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types"))],
...
def isa_ternary_arithmetic_env : Env := {
  structs := [("TritAddResult", [("sum", (.i32)), ("carry_out", (.i32))]), ("TritSubResult", [("diff", (.i32)), ("borrow_out", (.i32))]), ("WordAddResult", [("sum", (.struct "[TRITS_PER_WORD]i32")), ("carry_out", (.i32)), ("overflow", (.bool))]), ("WordSubResult", [("diff", (.struct "[TRITS_PER_WORD]i32")), ("borrow_out", (.i32)), ("underflow", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types"))],
  hostOnly := [],
...
def isa_ternary_gates_env : Env := {
  structs := [("GateResult", [("output", (.i32)), ("delay", (.u64))]), ("GateTruthTable", [("name", (.array 32 (.u8))), ("inputs", (.struct "usize")), ("outputs", (.struct "usize")), ("rows", (.array 27 (.i32))), ("row_count", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_layers_conv2d_layer_env : Env := {
  structs := [("Conv2DConfig", [("in_channels", (.u32)), ("out_channels", (.u32)), ("kernel_size", (.u32)), ("stride", (.u32)), ("padding", (.u32)), ("dilation", (.u32)), ("groups", (.u32)), ("has_bias", (.bool))]), ("PaddingMode", [("enum_type", (.struct "enum")), ("values", (.u32)), ("Zeros", (.struct "Auto")), ("Reflect", (.struct "Auto")), ("Replicate", (.struct "Auto")), ("Circular", (.struct "Auto"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
...
def ml_layers_conv2d_layer_module : Module := {
  ...
  functions := [{ name := "forward", params := [("input", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }, { name := "backward", params := [("grad_output", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }],
...
def ml_layers_dense_layer_env : Env := {
  structs := [("DenseConfig", [("input_size", (.u32)), ("output_size", (.u32)), ("has_bias", (.bool)), ("activation", (.struct "ActivationType"))]), ("ActivationType", [("enum_type", (.struct "enum")), ("values", (.u32)), ("None", (.struct "Auto")), ("ReLU", (.struct "Auto")), ("GELU", (.struct "Auto")), ("Sigmoid", (.struct "Auto")), ("Tanh", (.struct "Auto")), ("Softmax", (.struct "Auto"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def ml_layers_embedding_layer_env : Env := {
  structs := [("EmbeddingConfig", [("vocab_size", (.u32)), ("d_model", (.u32))]), ("EmbeddingWeights", [("W", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_layers_embedding_layer_module : Module := {
  ...
  functions := [{ name := "forward", params := [("token_ids", (.struct "[]const u32"))], ret := (some (.struct "void")), body := [] }, { name := "init", params := [("weights", (.struct "EmbeddingWeights"))], ret := (some (.struct "void")), body := [] }],
...
def ml_layers_flatten_layer_env : Env := {
  structs := [("FlattenConfig", [("input_shape", (.struct "[]u32"))]), ("InputTensor", [("dims", (.struct "[]u32")), ("data", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def ml_layers_flatten_layer_module : Module := {
  ...
  functions := [{ name := "calc_output_size", params := [("input_dims", (.struct "[]u32"))], ret := (some (.struct "void")), body := [] }, { name := "forward", params := [("input", (.struct "[]f32"))], ret := (some (.struct "void")), body := [] }],
...
def ml_layers_maxpool2d_layer_env : Env := {
  structs := [("MaxPool2DConfig", [("kernel_size", (.u32)), ("stride", (.u32)), ("padding", (.u32)), ("dilation", (.u32)), ("return_indices", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_layers_residual_connection_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "forward", params := [("input", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }],
...
def ml_loss_kl_divergence_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "forward", params := [("p", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "forward_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def ml_loss_mse_loss_env : Env := {
  structs := [("MSELossConfig", [("reduction", (.struct "[]constu8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_loss_mse_loss_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "forward", params := [("predictions", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "forward_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def ml_optimizer_lr_scheduler_env : Env := {
  structs := [("SchedulerConfig", [("max_steps", (.u32)), ("warmup_steps", (.u32)), ("min_lr", (.struct "gf16::GF16")), ("max_lr", (.struct "gf16::GF16")), ("use_phi_schedule", (.bool))]), ("SchedulerState", [("current_step", (.u64)), ("last_lr", (.struct "gf16::GF16")), ("config", (.struct "SchedulerConfig"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def ml_optimizer_lr_scheduler_module : Module := {
  ...
  functions := [{ name := "init", params := [("config", (.struct "SchedulerConfig"))], ret := (some (.struct "SchedulerState")), body := [] }, { name := "step", params := [("state", (.struct "SchedulerState"))], ret := (some (.struct "SchedulerState")), body := [] }],
...
def ml_optimizer_sgd_momentum_env : Env := {
  structs := [("SgdMomentumConfig", [("learning_rate", (.struct "gf16::GF16")), ("momentum", (.struct "gf16::GF16")), ("weight_decay", (.struct "gf16::GF16")), ("nesterov", (.bool)), ("use_phi_damping", (.bool)), ("dampening", (.struct "gf16::GF16"))]), ("SgdMomentumState", [("velocities", (.struct "[]gf16::GF16")), ("param_count", (.u32)), ("step", (.u64))]), ("OptimizerStepResult", [("updated_params", (.struct "[]gf16::GF16")), ("velocities", (.struct "[]gf16::GF16")), ("step_norm", (.struct "gf16::GF16"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def ml_optimizer_sgd_momentum_module : Module := {
  ...
  functions := [{ name := "init", params := [("config", (.struct "SgdMomentumConfig")), ("param_count", (.u32))], ret := (some (.struct "SgdMomentumState")), body := [] }, { name := "step", params := [("state", (.struct "SgdMomentumState")), ("params", (.struct "[]gf16::GF16")), ("grads", (.struct "[]gf16::GF16"))], ret := (some (.struct "OptimizerStepResult")), body := [] }, { name := "zero_grad", params := [("state", (.struct "SgdMomentumState"))], ret := (some (.struct "SgdMomentumState")), body := [] }],
...
def ml_pathway_mlp_env : Env := {
  structs := [("MLPConfig", [("input_size", (.u32)), ("hidden_size", (.u32)), ("output_size", (.u32))]), ("MLPState", [("w1", (.struct "[]f32")), ("b1", (.struct "[]f32")), ("w2", (.struct "[]f32")), ("b2", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_pathway_mlp_module : Module := {
  ...
  functions := [{ name := "forward", params := [("input", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }, { name := "init", params := [("state", (.struct "MLPState"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "forward_basic_case", params := [], ret := none, body := [] }, { name := "init_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def ml_recurrent_bilstm_env : Env := {
  structs := [("BiLSTMConfig", [("input_size", (.u32)), ("hidden_size", (.u32)), ("use_cell_state", (.bool))]), ("LSTMParams", [("w_i", (.struct "[]f32")), ("w_f", (.struct "[]f32")), ("w_o", (.struct "[]f32")), ("w_c", (.struct "[]f32")), ("b_i", (.struct "[]f32")), ("b_f", (.struct "[]f32")), ("b_o", (.struct "[]f32")), ("b_c", (.struct "[]f32"))]), ("LSTMCellState", [("h", (.struct "[]f32")), ("c", (.struct "[]f32"))]), ("BiLSTMOutput", [("h", (.struct "[]f32")), ("c", (.struct "[]f32")), ("h_fwd_final", (.struct "[]f32")), ("h_bwd_final", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_recurrent_bilstm_module : Module := {
  ...
  functions := [{ name := "forward_direction", params := [("inputs", (.struct "[][]f32"))], ret := (some (.struct "void")), body := [] }, { name := "forward", params := [("inputs", (.struct "[][]f32"))], ret := (some (.struct "void")), body := [] }],
...
def ml_recurrent_gru_cell_env : Env := {
  structs := [("GRUConfig", [("input_size", (.u32)), ("hidden_size", (.u32))]), ("GRUState", [("h", (.struct "[]f32"))]), ("GRUWeights", [("Wr", (.struct "[]f32")), ("br", (.struct "[]f32")), ("Wz", (.struct "[]f32")), ("bz", (.struct "[]f32")), ("Wh", (.struct "[]f32")), ("bh", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_recurrent_gru_cell_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "forward", params := [("input", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }, { name := "init", params := [("weights", (.struct "GRUWeights"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "forward_basic_case", params := [], ret := none, body := [] }, { name := "init_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def ml_recurrent_lstm_cell_env : Env := {
  structs := [("LSTMConfig", [("input_size", (.u32)), ("hidden_size", (.u32))]), ("LSTMState", [("h", (.struct "[]f32")), ("c", (.struct "[]f32"))]), ("LSTMWeights", [("Wf", (.struct "[]f32")), ("bf", (.struct "[]f32")), ("Wi", (.struct "[]f32")), ("bi", (.struct "[]f32")), ("Wo", (.struct "[]f32")), ("bo", (.struct "[]f32")), ("Wg", (.struct "[]f32")), ("bg", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def ml_recurrent_lstm_cell_module : Module := {
  ...
  functions := [{ name := "forward", params := [("input", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }, { name := "init", params := [("weights", (.struct "LSTMWeights"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "forward_basic_case", params := [], ret := none, body := [] }, { name := "init_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def ml_recurrent_rnn_cell_env : Env := {
  structs := [("RNNCellConfig", [("input_size", (.u32)), ("hidden_size", (.u32))]), ("RNNState", [("hidden", (.struct "[]f32")), ("cell", (.struct "[]f32"))]), ("RNNParams", [("w_x", (.struct "[]f32")), ("w_h", (.struct "[]f32")), ("b", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def ml_recurrent_rnn_cell_module : Module := {
  ...
  functions := [{ name := "forward_step", params := [("input", (.struct "[]f32"))], ret := (some (.struct "void")), body := [] }, { name := "forward_sequence", params := [("inputs", (.struct "[][]f32"))], ret := (some (.struct "void")), body := [] }, { name := "init_state", params := [("hidden_size", (.u32))], ret := (some (.struct "void")), body := [] }],
...
def ml_recurrent_self_attention_env : Env := {
  structs := [("SelfAttentionConfig", [("hidden_size", (.u32)), ("num_heads", (.u32)), ("d_model", (.u32))]), ("SelfAttentionWeights", [("Wq", (.struct "[]f32")), ("Wk", (.struct "[]f32")), ("Wv", (.struct "[]f32")), ("Wo", (.struct "[]f32"))]), ("SelfAttentionState", [("q", (.struct "[]f32")), ("k", (.struct "[]f32")), ("v", (.struct "[]f32")), ("attn", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_recurrent_seq2seq_env : Env := {
  structs := [("Seq2SeqConfig", [("vocab_size", (.u32)), ("d_model", (.u32)), ("hidden_size", (.u32))]), ("Seq2SeqState", [("encoder_hidden", (.struct "[]f32")), ("encoder_context", (.struct "[]f32")), ("decoder_hidden", (.struct "[]f32"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def ml_recurrent_seq2seq_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "encode", params := [("input_seq", (.struct "[]const u32"))], ret := (some (.struct "void")), body := [] }, { name := "decode", params := [("target_seq", (.struct "[]const u32"))], ret := (some (.struct "void")), body := [] }],
...
def ml_transformer_feed_forward_network_env : Env := {
  structs := [("FFNConfig", [("d_model", (.u32)), ("d_ff", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def ml_transformer_multi_head_attention_env : Env := {
  structs := [("MHAConfig", [("d_model", (.u32)), ("num_heads", (.u32)), ("d_k", (.u32)), ("causal", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_transformer_multi_head_attention_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "forward", params := [("query", (.struct "[]const f32"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "forward_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def ml_transformer_positional_encoding_env : Env := {
  structs := [("PosEncConfig", [("d_model", (.u32)), ("max_len", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def ml_transformer_positional_encoding_module : Module := {
  ...
  functions := [{ name := "forward", params := [("positions", (.struct "[]const u32"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "forward_basic_case", params := [], ret := none, body := [] }],
  benches := []
}
...
def numeric_bigint_env : Env := {
  structs := [("TVCBigInt", [("trits", (.struct "[MAX_TRITS]i8")), ("len", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
...
def physics_su2_chern_simons_env : Env := {
  structs := [("FusionMatrix", [("entries", (.struct "[[i64"))])],
...
def physics_su2_chern_simons_module : Module := {
  ...
  functions := [{ name := "fibonacci_fusion_matrix", params := [], ret := (some (.struct "FusionMatrix")), body := [] }],
  tests := [],
  benches := []
}

def queen_task_analysis_env : Env := {
  structs := [("SacredPhysics::SacredPhysicsReport", [("trinity_value", (.struct "f64")), ("trinity_ok", (.bool)), ("gamma_value", (.struct "f64")), ("c_threshold", (.struct "f64")), ("t_present_ms", (.struct "f64")), ("g_pred", (.struct "f64")), ("g_measured", (.struct "f64")), ("g_rel_error", (.struct "f64")), ("g_ok", (.bool)), ("omega_pred", (.struct "f64")), ("omega_measured", (.struct "f64")), ("omega_rel_error", (.struct "f64")), ("omega_ok", (.bool)), ("f_gamma_pred", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("SacredPhysics::TrinityVerification", [("phi_value", (.struct "f64")), ("phi_sq_value", (.struct "f64")), ("phi_inv_sq", (.struct "f64")), ("trinity_value", (.struct "f64")), ("target", (.struct "f64")), ("absolute_error", (.struct "f64")), ("relative_error", (.struct "f64")), ("passes", (.bool)), ("tolerance", (.struct "f64"))])],
  constructors := [],
  enums := [],
  imports := [("", ("math::sacred_physics", "")), ("Trit", ("base::types", "Trit"))],
  hostOnly := [],
...
def sacred_sacred_constants_env : Env := {
  structs := [("SacredConstants", [("note", (.struct "Namespacestructallmembersarecomptimeconstantsorpurefunctions"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def sacred_sacred_governance_env : Env := {
  structs := [("SacredRule", [("rule_type", (.struct "SacredRuleType")), ("penalty_weight", (.struct "Float"))]), ("SacredRuleType", []), ("RuleViolation", [("rule_type", (.struct "SacredRuleType")), ("severity", (.struct "ViolationSeverity")), ("file_path", (.struct "String")), ("line_number", (.struct "Int")), ("message", (.struct "String")), ("phi_penalty", (.struct "Float")), ("timestamp", (.struct "Int"))]), ("ViolationSeverity", []), ("GovernanceState", [("active_rules", (.struct "List<SacredRule>")), ("violation_count", (.struct "Int")), ("sacred_score", (.struct "Float")), ("last_action", (.struct "String")), ("last_check_time", (.struct "Int")), ("rollback_threshold", (.struct "Float")), ("is_locked", (.struct "Bool"))]), ("SacredComplianceReport", [("file_path", (.struct "String")), ("is_compliant", (.struct "Bool")), ("score", (.struct "Float")), ("violations", (.struct "List<RuleViolation>")), ("phi_harmony", (.struct "Float")), ("trinity_balance", (.struct "Float")), ("gematria_coverage", (.struct "Float"))]), ("PatchAction", [("patch_id", (.struct "String")), ("files_changed", (.struct "List<String>")), ("diff", (.struct "String")), ("author", (.struct "String")), ("timestamp", (.struct "Int"))]), ("GovernanceResult", [("approved", (.struct "Bool")), ("sacred_score_before", (.struct "Float")), ("sacred_score_after", (.struct "Float")), ("violations", (.struct "List<RuleViolation>")), ("action_taken", (.struct "String")), ("rollback_triggered", (.struct "Bool")), ("message", (.struct "String"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def sacred_sacred_identity_env : Env := {
  structs := [("SacredIdentity", [("purpose", (.struct "String")), ("trinity_aspect", (.struct "String")), ("incarnation_id", (.struct "String")), ("birth_timestamp", (.struct "Int")), ("last_active", (.struct "Int"))]), ("IdentityProof", [("phi_squared", (.struct "Float")), ("inverse_phi_squared", (.struct "Float")), ("sum", (.struct "Float")), ("trinity_value", (.struct "Float")), ("verified", (.struct "Bool")), ("tolerance", (.struct "Float"))]), ("SacredTimestamp", [("unix_time", (.struct "Int")), ("phi_time", (.struct "Float")), ("trinity_time", (.struct "Float")), ("golden_phase", (.struct "Float")), ("cosmic_alignment", (.struct "Float"))]), ("IdentityLogEntry", [("timestamp", (.struct "SacredTimestamp")), ("level", (.struct "String")), ("message", (.struct "String")), ("identity_hash", (.struct "List<Int>")), ("sacred_signature", (.struct "String"))]), ("TrinityAwareness", [("knows_identity", (.struct "Bool")), ("understands_architecture", (.struct "Bool")), ("recognizes_sacred_math", (.struct "Bool")), ("evolution_count", (.struct "Int")), ("wisdom_level", (.struct "Int")), ("alignment_score", (.struct "Float"))]), ("IdentityConfig", [("log_path", (.struct "String")), ("persist_identity", (.struct "Bool")), ("verify_on_startup", (.struct "Bool")), ("declare_in_logs", (.struct "Bool")), ("sacred_timestamps", (.struct "Bool")), ("tolerance_pct", (.struct "Float"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_agent_autonomous_lifecycle_env : Env := {
  structs := [("LifecycleState", [("variants", (.u32))]), ("LifecycleEvent", [("event_id", (.struct "String")), ("from_state", (.struct "LifecycleState")), ("to_state", (.struct "LifecycleState")), ("timestamp", (.i64)), ("pas_score", (.struct "Float-weightedpriority")), ("trigger", (.struct "String"))]), ("AutonomousAgent", [("agent_id", (.struct "String")), ("state", (.struct "LifecycleState")), ("current_task", (.struct "Option<Task>")), ("task_history", (.struct "List<Task>")), ("performance_metrics", (.struct "PerformanceMetrics")), ("sacred_rating", (.struct "Float"))]), ("Task", [("task_id", (.struct "String")), ("task_type", (.struct "TaskType")), ("spec_file", (.struct "Option<string>")), ("priority", (.struct "Float")), ("dependencies", (.struct "List<string>")), ("status", (.struct "TaskStatus"))]), ("TaskType", [("variants", (.u32))]), ("TaskStatus", [("variants", (.u32))]), ("PerformanceMetrics", [("tasks_completed", (.struct "Int")), ("tasks_failed", (.struct "Int")), ("avg_task_time_ms", (.struct "Float")), ("pas_score_avg", (.struct "Float")), ("uptime_percentage", (.struct "Float"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_agent_eternal_monitor_env : Env := {
  structs := [("Severity", [("variants", (.u32))]), ("HealthStatus", [("variants", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_agent_faculty_board_env : Env := {
  structs := [("Lang", [("variants", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_agent_governance_agent_env : Env := {
  structs := [("GovernanceAgent", [("identity", (.struct "StringGOVERNANCEAGENT of Sacred Intelligence")), ("sacred_score", (.struct "Float0-1scale")), ("generation", (.struct "Int")), ("total_violations", (.struct "Int")), ("total_enforcements", (.struct "Int")), ("last_check_timestamp", (.struct "Int64"))]), ("SacredRule", [("weight", (.struct "Float-basedweight")), ("penalty_multiplier", (.struct "Float")), ("enabled", (.struct "Bool"))]), ("Violation", [("rule", (.struct "StringWhichsacredrulewasviolated")), ("file_path", (.struct "String")), ("line_number", (.struct "Int")), ("severity", (.struct "Stringcritical")), ("warning", (.u32)), ("info", (.u32)), ("penalty", (.struct "Float-basedpenaltyscore")), ("timestamp", (.struct "Int64")), ("commit_hash", (.struct "String")), ("auto_rollback", (.struct "Bool")), ("resolved", (.struct "Bool"))]), ("SacredScore", [("phi_harmony", (.struct "FloatCosinesimilarityto")), ("trinity_balance", (.struct "FloatTernarybalance(-1")), ("gematria_compliance", (.struct "FloatSacrednameusage")), ("evolution_fitness", (.struct "FloatFitnessimprovement")), ("test_safety", (.struct "FloatTestspassing")), ("overall_score", (.struct "FloatWeightedaverage0-1")), ("timestamp", (.struct "Int64"))]), ("PatchRequest", [("patch_id", (.struct "String")), ("author", (.struct "String")), ("files", (.struct "List<String>")), ("pre_score", (.struct "Float")), ("post_score", (.struct "Float")), ("delta", (.struct "Float")), ("status", (.struct "Stringpending")), ("approved", (.u32)), ("rejected", (.u32)), ("rolledBack", (.u32)), ("approver", (.struct "String")), ("timestamp", (.struct "Int64"))]), ("PreCommitState", [("enabled", (.struct "Bool")), ("block_on_violation", (.struct "Bool")), ("auto_rollback_threshold", (.struct "Float")), ("allowed_overrides", (.struct "List<String>")), ("last_check_result", (.struct "String"))]), ("GovernanceWidget", [("current_score", (.struct "Float")), ("trend", (.struct "Stringimproving")), ("stable", (.u32)), ("declining", (.u32)), ("violations_today", (.struct "Int")), ("enforcements_today", (.struct "Int")), ("pending_patches", (.struct "Int")), ("last_update", (.struct "Int64"))]), ("AuditEntry", [("id", (.struct "String")), ("timestamp", (.struct "Int64")), ("action", (.struct "Stringcheck")), ("enforce", (.u32)), ("rollback", (.u32)), ("approve", (.u32)), ("rule", (.struct "String")), ("outcome", (.struct "Stringpassed")), ("failed", (.u32)), ("warning", (.u32)), ("details", (.struct "String")), ("sacred_score_before", (.struct "Float")), ("sacred_score_after", (.struct "Float")), ("agent_identity", (.struct "String"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_agent_handoff_env : Env := {
  structs := [("PlannerOutput", [("issue_number", (.struct "UInt32")), ("subtasks", (.struct "[[]Const[")), ("files", (.struct "[[]Const[")), ("approach", (.struct "String")), ("spec_path", (.struct "String")), ("timestamp", (.struct "Int64")), ("cost_tokens_in", (.struct "UInt64")), ("cost_tokens_out", (.struct "UInt64")), ("cost_usd", (.struct "Float64"))]), ("CoderOutput", [("issue_number", (.struct "UInt32")), ("branch", (.struct "String")), ("files_modified", (.struct "[[]Const[")), ("commits", (.struct "[[]Const[")), ("lines_added", (.struct "UInt32")), ("lines_removed", (.struct "UInt32")), ("timestamp", (.struct "Int64")), ("cost_tokens_in", (.struct "UInt64")), ("cost_tokens_out", (.struct "UInt64")), ("cost_usd", (.struct "Float64"))]), ("ReviewerVerdict", [("issue_number", (.struct "UInt32")), ("approved", (.struct "Bool")), ("feedback", (.struct "[[]Const[")), ("iteration", (.struct "UInt8")), ("max_iterations", (.struct "UInt8")), ("files_reviewed", (.struct "[[]Const[")), ("timestamp", (.struct "Int64")), ("cost_tokens_in", (.struct "UInt64")), ("cost_tokens_out", (.struct "UInt64")), ("cost_usd", (.struct "Float64"))]), ("TesterReport", [("issue_number", (.struct "UInt32")), ("tests_passed", (.struct "UInt32")), ("tests_total", (.struct "UInt32")), ("benchmarks", (.struct "[[]Const[")), ("regressions", (.struct "[[]Const[")), ("timestamp", (.struct "Int64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_agent_swarm_agents_env : Env := {
  structs := [("AgentType", [("variants", (.u32))]), ("AgentStatus", [("variants", (.u32))]), ("Agent", [("id", (.struct "String")), ("agent_type", (.struct "AgentType")), ("status", (.struct "AgentStatus")), ("sacred_role", (.struct "String")), ("phi_score", (.struct "Float")), ("task_queue", (.struct "List<Task>")), ("completed_tasks", (.struct "List<Task>")), ("sacred_declaration", (.struct "String"))]), ("Task", [("task_id", (.struct "String")), ("priority", (.struct "Float-weighted0-1")), ("assigned_to", (.struct "Option<AgentType>")), ("status", (.struct "TaskStatus")), ("result", (.struct "Option<String>")), ("sacred_formula", (.struct "Option<String>"))]), ("TaskStatus", [("variants", (.u32))]), ("SwarmState", [("agents", (.struct "List<Agent>")), ("coordination_mode", (.struct "CoordinationMode")), ("phi_harmony_score", (.struct "Float0-1")), ("target", (.u32)), ("consensus_threshold", (.struct "FloatDefault0.95")), ("active_tasks", (.struct "List<Task>")), ("completed_tasks", (.struct "List<Task>")), ("iteration_count", (.struct "Int")), ("sacred_bond", (.struct "Float"))]), ("CoordinationMode", [("variants", (.u32))]), ("ConsensusProposal", [("proposal_id", (.struct "String")), ("agent_type", (.struct "AgentType")), ("proposal_text", (.struct "String")), ("phi_weight", (.struct "Float")), ("votes", (.struct "List<Vote>")), ("consensus_score", (.struct "Float")), ("status", (.struct "ConsensusStatus"))]), ("Vote", [("agent_id", (.struct "String")), ("agent_type", (.struct "AgentType")), ("approve", (.struct "Bool")), ("phi_influence", (.struct "Float")), ("rationale", (.struct "String"))]), ("ConsensusStatus", [("variants", (.u32))]), ("SwarmHarmonyMetrics", [("cosine_similarity", (.struct "FloatVSAcosinesimilarity")), ("consensus_rate", (.struct "FloatApproved/Total")), ("task_success_rate", (.struct "FloatCompleted/Total")), ("phi_alignment", (.struct "FloatHowalignedwithsacredmath")), ("overall_harmony", (.struct "FloatCombinedscore0-1"))]), ("AgentCommunication", [("from_agent_id", (.struct "String")), ("to_agent_id", (.struct "String")), ("message_type", (.struct "MessageType")), ("content", (.struct "String")), ("phi_signature", (.struct "Float")), ("timestamp", (.struct "Int"))]), ("MessageType", [("variants", (.u32))]), ("SacredPattern", [("pattern_id", (.struct "String")), ("discovered_by", (.struct "AgentType")), ("phi_ratio", (.struct "Float")), ("trinity_aligned", (.struct "Bool")), ("formula_string", (.struct "String")), ("gematria_value", (.struct "Int")), ("confidence", (.struct "Float"))]), ("TaskResult", [("agent_id", (.struct "String")), ("task_id", (.struct "String")), ("result", (.struct "String")), ("phi_score", (.struct "Float"))]), ("SacredFormula", [("Math", (.u32)), ("sacredFormula", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_collections_btree_env : Env := {
  structs := [("", [("root", (.struct "BTreeNode(K, V)")), ("order", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_collections_either_env : Env := {
  structs := [("", [("is_left", (.bool)), ("left", (.struct "L")), ("right", (.struct "R"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_collections_interval_env : Env := {
  structs := [("Interval", [("start", (.i64)), ("end", (.i64)), ("inclusive", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_collections_linked_list_env : Env := {
  structs := [("ListNode", [("value", (.struct "T")), ("prev", (.struct "?ListNode")), ("next", (.struct "?ListNode"))]), ("LinkedList", [("head", (.struct "?ListNode")), ("tail", (.struct "?ListNode")), ("length", (.struct "usize")), ("allocator", (.struct "std.mem.Allocator"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def tri_collections_linked_list_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [], ret := (some (.struct "LinkedList")), body := [] }, { name := "append", params := [("list", (.struct "*LinkedList"))], ret := (some (.struct "void")), body := [] }, { name := "prepend", params := [("list", (.struct "*LinkedList"))], ret := (some (.struct "void")), body := [] }, { name := "remove", params := [("list", (.struct "*LinkedList"))], ret := (some (.struct "void")), body := [] }, { name := "deinit", params := [("list", (.struct "*LinkedList"))], ret := (some (.struct "void")), body := [] }],
...
def tri_collections_list_env : Env := {
  structs := [("", [("is_empty", (.bool)), ("head", (.struct "T")), ("tail", (.struct "List(T)"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_collections_lockfree_stack_env : Env := {
  structs := [("LFNode", [("value", (.i64)), ("next", (.struct "?*LFNode"))]), ("LockFreeStack", [("head", (.struct "?*LFNode"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def tri_collections_lockfree_stack_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [], ret := (some (.struct "LockFreeStack")), body := [] }, { name := "push", params := [("s", (.struct "*LockFreeStack"))], ret := (some (.struct "void")), body := [] }, { name := "pop", params := [("s", (.struct "*LockFreeStack"))], ret := (some (.struct "void")), body := [] }],
...
def tri_collections_lru_cache_env : Env := {
  structs := [("LRUCache", [("generic", (.struct "K, V")), ("capacity", (.struct "usize")), ("size", (.struct "usize")), ("head", (.struct "*Node")), ("tail", (.struct "*Node")), ("map", (.struct "HashMap(K, *Node)"))]), ("Node", [("generic", (.struct "K, V")), ("key", (.struct "K")), ("value", (.struct "V")), ("prev", (.struct "*Node")), ("next", (.struct "*Node"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_collections_lru_cache_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [("capacity", (.struct "usize"))], ret := (some (.struct "void")), body := [] }, { name := "get", params := [("cache", (.struct "*LRUCache"))], ret := (some (.struct "void")), body := [] }, { name := "put", params := [("cache", (.struct "*LRUCache"))], ret := (some (.struct "void")), body := [] }],
...
def tri_collections_map_env : Env := {
  structs := [("", [("keys", (.struct "[[]K,
        values : [[]V"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_collections_namespace_env : Env := {
  structs := [("Namespace", [("kind", (.struct "Enum")), ("variants", (.u32))]), ("ParsedCommand", [("kind", (.struct "Union(enum)")), ("variants", (.u32)), ("namespaced", (.u32)), ("flat", (.u32)), ("help", (.struct "void"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_collections_option_env : Env := {
  structs := [("", [("is_some", (.bool)), ("value", (.struct "T"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_collections_queue_env : Env := {
  structs := [("", [("front", (.struct "[[]T,
        back : [[]T"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_collections_result_env : Env := {
  structs := [("", [("is_ok", (.bool)), ("value", (.struct "T")), ("error", (.struct "E"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_collections_tuple_env : Env := {
  structs := [("", [("first", (.struct "A")), ("second", (.struct "B"))]), ("", [("first", (.struct "A")), ("second", (.struct "B")), ("third", (.struct "C"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_crypto_crypto_env : Env := {
  structs := [("KeyPair", [("public_key", (.struct "[[]U8,
        private_key : [[]U8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_crypto_crypto_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "generate_key_pair", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "sha256", params := [("data", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "hmac", params := [("key", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }],
...
def tri_crypto_ecc_env : Env := {
  structs := [("ECPoint", [("x", (.struct "f64")), ("y", (.struct "f64")), ("is_infinity", (.bool))]), ("EllipticCurve", [("a", (.struct "f64")), ("b", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_crypto_ecc_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "add", params := [("curve", (.struct "*EllipticCurve"))], ret := (some (.struct "void")), body := [] }, { name := "multiply", params := [("curve", (.struct "*EllipticCurve"))], ret := (some (.struct "void")), body := [] }, { name := "is_on_curve", params := [("curve", (.struct "*EllipticCurve"))], ret := (some (.struct "void")), body := [] }],
...
def tri_crypto_reed_solomon_env : Env := {
  structs := [("RSCode", [("data_shards", (.struct "usize")), ("parity_shards", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_crypto_reed_solomon_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "encode", params := [("data", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "decode", params := [("shards", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "encode_basic_case", params := [], ret := none, body := [] }, { name := "decode_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def tri_crypto_rsa_env : Env := {
  structs := [("RSAKeyPair", [("public_e", (.u64)), ("public_n", (.u64)), ("private_d", (.u64)), ("private_n", (.u64))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_crypto_rsa_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "generate", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "encrypt", params := [("message", (.u64))], ret := (some (.struct "void")), body := [] }, { name := "decrypt", params := [("ciphertext", (.u64))], ret := (some (.struct "void")), body := [] }],
...
def tri_encoding_bson_env : Env := {
  structs := [("BsonValue", [("Double", (.u32)), ("String", (.u32)), ("Document", (.u32)), ("Array", (.u32)), ("Binary", (.u32)), ("ObjectId", (.u32)), ("Boolean", (.u32)), ("DateTime", (.u32)), ("Null", (.u32)), ("Int32", (.u32)), ("Int64", (.u32))]), ("BsonDocument", []), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_encoding_bson_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "parse", params := [("data", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "serialize", params := [("doc", (.struct "BsonDocument"))], ret := (some (.struct "void")), body := [] }],
...
def tri_encoding_csv_env : Env := {
  structs := [("CsvRow", []), ("CsvDocument", [("headers", (.struct "[[]CsvRow,
        rows : [[]CsvRow")), ("delimiter", (.u8))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_encoding_csv_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "parse", params := [("text", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "get", params := [("doc", (.struct "CsvDocument"))], ret := (some (.struct "void")), body := [] }, { name := "set", params := [("doc", (.struct "*CsvDocument"))], ret := (some (.struct "void")), body := [] }, { name := "serialize", params := [("doc", (.struct "CsvDocument"))], ret := (some (.struct "void")), body := [] }],
...
def tri_encoding_html_env : Env := {
  structs := [("HtmlNode", [("tag", (.struct "[[]Constu8,
        attributes : [std.StringHashMap([]Const u8)")), ("children", (.struct "[[]HtmlNode,
        inner_text : [[]Const u8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_encoding_html_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "parse", params := [("html", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "query_selector", params := [("node", (.struct "HtmlNode"))], ret := (some (.struct "void")), body := [] }],
...
def tri_encoding_json_env : Env := {
  structs := [("JsonValue", [("type", (.struct "JsonType")), ("data", (.struct "*JsonValueData"))]), ("JsonType", [("Null", (.u32)), ("Bool", (.u32)), ("Number", (.u32)), ("String", (.u32)), ("Array", (.u32)), ("Object", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_encoding_msgpack_env : Env := {
  structs := [("MsgPackType", [("Nil", (.u32)), ("Bool", (.u32)), ("Int", (.u32)), ("Uint", (.u32)), ("Float", (.u32)), ("Str", (.u32)), ("Bin", (.u32)), ("Array", (.u32)), ("Map", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_encoding_xml_env : Env := {
  structs := [("XmlNode", [("tag", (.struct "[[]Constu8,
        attributes : [std.StringHashMap([]Const u8)")), ("children", (.struct "[[]XmlNode,
        text : [[]Const u8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_encoding_xml_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "parse", params := [("text", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "format", params := [("node", (.struct "XmlNode"))], ret := (some (.struct "void")), body := [] }],
...
def tri_graph_dijkstra_env : Env := {
  structs := [("DijkstraResult", [("distance", (.struct "[[]F64,
        parent : [[]?Usize")), ("allocator", (.struct "std.mem.Allocator"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_graph_dijkstra_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "shortest_path", params := [("graph", (.struct "*Graph"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "shortest_path_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def tri_graph_graph_env : Env := {
  structs := [("", [("nodes", (.struct "[std.HashMap(T")), ("T", (.u32)), ("bool", (.u32)), ("cost", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_graph_graph_bfs_env : Env := {
  structs := [("Graph", [("adj", (.struct "[[][")), ("allocator", (.struct "std.mem.Allocator"))]), ("BFSResult", [("order", (.struct "[[]Usize,
        distance : [[]Usize")), ("allocator", (.struct "std.mem.Allocator"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_graph_graph_bfs_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "add_edge", params := [("graph", (.struct "*Graph"))], ret := (some (.struct "void")), body := [] }, { name := "traverse", params := [("graph", (.struct "*Graph"))], ret := (some (.struct "void")), body := [] }, { name := "deinit", params := [("graph", (.struct "*Graph"))], ret := (some (.struct "void")), body := [] }],
...
def tri_graph_graph_dfs_env : Env := {
  structs := [("DFSResult", [("preorder", (.struct "[[]Usize,
        postorder : [[]Usize")), ("allocator", (.struct "std.mem.Allocator"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_graph_graph_dfs_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "traverse", params := [("graph", (.struct "*Graph"))], ret := (some (.struct "void")), body := [] }],
...
def tri_io_filesystem_env : Env := {
  structs := [("PathError", []), ("FileInfo", [("path", (.struct "[]constu8")), ("size", (.u64)), ("is_dir", (.bool)), ("is_file", (.bool)), ("modified", (.u64))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_io_filesystem_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "join", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "basename", params := [("path", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "dirname", params := [("path", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "ext", params := [("path", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "has_ext", params := [("path", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "is_absolute", params := [("path", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "normalize", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }],
...
def tri_io_fs_env : Env := {
  structs := [("Path", [("parts", (.struct "[[][")), ("absolute", (.bool))]), ("FileInfo", [("size", (.u64)), ("is_dir", (.bool)), ("is_file", (.bool)), ("modified", (.struct "Instant"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_io_fs_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "join", params := [("base", (.struct "Path"))], ret := (some (.struct "void")), body := [] }, { name := "basename", params := [("path", (.struct "Path"))], ret := (some (.struct "void")), body := [] }, { name := "dirname", params := [("path", (.struct "Path"))], ret := (some (.struct "void")), body := [] }, { name := "extension", params := [("path", (.struct "Path"))], ret := (some (.struct "void")), body := [] }],
...
def tri_io_zip_env : Env := {
  structs := [("", [("focus", (.struct "T")), ("left", (.struct "List(T)")), ("right", (.struct "List(T)"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_math_bezier_env : Env := {
  structs := [("Point", [("x", (.struct "f64")), ("y", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_math_constants_env : Env := {
  structs := [("SystemLimits", [("max_path_len", (.struct "usize")), ("max_line_len", (.struct "usize")), ("max_args", (.struct "usize")), ("max_env_vars", (.struct "usize"))]), ("SacredConstants", [("phi", (.struct "f64")), ("pi", (.struct "f64")), ("e", (.struct "f64")), ("sqrt2", (.struct "f64")), ("sqrt3", (.struct "f64")), ("golden_ratio", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def tri_math_probability_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "bernoulli", params := [("p", (.struct "f64"))], ret := (some (.struct "void")), body := [] }, { name := "binomial", params := [("n", (.struct "usize"))], ret := (some (.struct "void")), body := [] }, { name := "poisson", params := [("lambda", (.struct "f64"))], ret := (some (.struct "void")), body := [] }, { name := "normal", params := [("mean", (.struct "f64"))], ret := (some (.struct "void")), body := [] }, { name := "exponential", params := [("lambda", (.struct "f64"))], ret := (some (.struct "void")), body := [] }],
...
def tri_net_async_env : Env := {
  structs := [("", [("completed", (.bool)), ("value", (.struct "T"))]), ("", [("fulfilled", (.bool)), ("future", (.struct "Future(T)"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_net_async_stream_env : Env := {
  structs := [("", [("generator", (.struct "fn() ?T")), ("state", (.struct "StreamState"))]), ("StreamState", [("Ready", (.u32)), ("Pending", (.u32)), ("Done", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_net_channel_env : Env := {
  structs := [("", [("capacity", (.struct "usize")), ("sender_count", (.struct "usize")), ("receiver_count", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_net_http_env : Env := {
  structs := [("HttpMethod", []), ("HttpStatus", [("code", (.u16)), ("reason", (.struct "[]constu8"))]), ("Url", [("scheme", (.struct "[]constu8")), ("host", (.struct "[]constu8")), ("port", (.u16)), ("path", (.struct "[]constu8")), ("query", (.struct "[]constu8")), ("fragment", (.struct "[]constu8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_net_http_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "method_to_string", params := [("method", (.struct "HttpMethod"))], ret := (some (.struct "void")), body := [] }, { name := "status_from_code", params := [("code", (.u16))], ret := (some (.struct "void")), body := [] }, { name := "is_success", params := [("code", (.u16))], ret := (some (.struct "void")), body := [] }, { name := "is_redirect", params := [("code", (.u16))], ret := (some (.struct "void")), body := [] }, { name := "is_client_error", params := [("code", (.u16))], ret := (some (.struct "void")), body := [] }, { name := "is_server_error", params := [("code", (.u16))], ret := (some (.struct "void")), body := [] }, { name := "parse_url", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }],
...
def tri_net_net_env : Env := {
  structs := [("IpAddress", [("is_v6", (.bool)), ("bytes", (.array 16 (.u8)))]), ("SocketAddr", [("ip", (.struct "IpAddress")), ("port", (.u16))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_net_net_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "parse_ip", params := [("addr", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "is_localhost", params := [("addr", (.struct "IpAddress"))], ret := (some (.struct "void")), body := [] }, { name := "is_valid_port", params := [("port", (.u16))], ret := (some (.struct "void")), body := [] }],
...
def tri_pipeline_batch_runner_env : Env := {
  structs := [("CompileStatus", [("variants", (.u32))]), ("FilterMode", [("variants", (.u32))]), ("PipelineResult", [("spec_path", (.struct "String")), ("success", (.struct "Bool")), ("status", (.struct "CompileStatus")), ("duration_ns", (.struct "Int")), ("error_msg", (.struct "String"))]), ("BatchConfig", [("parallel", (.struct "Int")), ("filter", (.struct "FilterMode")), ("directory", (.struct "String")), ("dry_run", (.struct "Bool")), ("timeout_seconds", (.struct "Int"))]), ("BatchReport", [("total_specs", (.struct "Int")), ("filtered_specs", (.struct "Int")), ("passed", (.struct "Int")), ("failed", (.struct "Int")), ("skipped", (.struct "Int")), ("total_duration_ns", (.struct "Int")), ("parallel_workers", (.struct "Int")), ("failures", (.struct "List(FailureEntry)"))]), ("FailureEntry", [("spec", (.struct "String")), ("status", (.struct "CompileStatus")), ("error_msg", (.struct "String"))]), ("ThreadSafeResults", [("items", (.struct "List(PipelineResult)")), ("lock_active", (.struct "Bool"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_pipeline_codegen_env : Env := {
  structs := [("ParseError", [("message", (.struct "String")), ("line", (.struct "Int")), ("column", (.struct "Int")), ("source", (.struct "String"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_pipeline_pipeline_parallel_env : Env := {
  structs := [("JobStatus", [("pending", (.u32)), ("running", (.u32)), ("completed", (.u32)), ("failed", (.u32)), ("skipped", (.u32))]), ("DagJob", [("id", (.struct "U80..MAXJOBS-1")), ("command", (.struct "Stringtrisubcommandtoexecute")), ("args", (.struct "Stringargumentsstring")), ("group_id", (.struct "U8whichexecutiongroup")), ("status", (.struct "JobStatus")), ("exit_code", (.struct "U8processexitcode")), ("duration_ms", (.u64))]), ("GroupResult", [("group_id", (.u8)), ("total", (.u8)), ("completed", (.u8)), ("failed", (.u8)), ("duration_ms", (.u64))]), ("PipelineDAG", [("jobs", (.struct "List<DagJob>max16")), ("job_count", (.u8)), ("groups", (.struct "List<GroupResult>max8")), ("group_count", (.u8)), ("status", (.struct "JobStatusoverallDAGstatus"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_pipeline_workflow_env : Env := {
  structs := [("WorkflowStep", [("command", (.struct "String")), ("depends_on", (.struct "[[]Const[")), ("condition", (.struct "[[]Constu8,
    };

    pub const Workflow = struct {
        version : String,
        steps : [[]Const WorkflowStep"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_search_knuth_morris_pratt_env : Env := {
  structs := [("KMPPrefix", [("table", (.struct "[[]Usize,
        pattern : [[]Const u8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_search_knuth_morris_pratt_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "build_prefix", params := [("pattern", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "search", params := [("text", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }],
...
def tri_search_match_env : Env := {
  structs := [("Match", [("matched", (.bool)), ("captures", (.struct "[]MatchCapture"))]), ("MatchCapture", [("value", (.struct "[]constu8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_search_pattern_env : Env := {
  structs := [("MatchResult", [("matches", (.bool)), ("captured", (.struct "[]constu8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_search_pattern_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "glob_match", params := [("pattern", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "wildcard_match", params := [("pattern", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }],
...
def tri_search_rabin_karp_env : Env := {
  structs := [("RKState", [("pattern_hash", (.u64)), ("pattern_len", (.struct "usize")), ("base", (.u64)), ("modulus", (.u64))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_search_rabin_karp_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [("pattern", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "search", params := [("state", (.struct "*RKState"))], ret := (some (.struct "void")), body := [] }],
...
def tri_search_regex_advanced_env : Env := {
  structs := [("RegexFlags", [("IgnoreCase", (.u32)), ("Multiline", (.u32)), ("DotAll", (.u32))]), ("RegexMatch", [("matched", (.bool)), ("groups", (.struct "[[][")), ("start", (.struct "usize")), ("end", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_search_regex_advanced_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "compile", params := [("pattern", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "match", params := [("regex", (.struct "Regex"))], ret := (some (.struct "void")), body := [] }, { name := "replace", params := [("regex", (.struct "Regex"))], ret := (some (.struct "void")), body := [] }],
...
def tri_search_search_env : Env := {
  structs := [("SearchResult", [("index", (.struct "?usize")), ("found", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_search_search_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "binary", params := [("sorted", (.struct "[]const T"))], ret := (some (.struct "void")), body := [] }, { name := "linear", params := [("items", (.struct "[]const T"))], ret := (some (.struct "void")), body := [] }, { name := "lower_bound", params := [("sorted", (.struct "[]const T"))], ret := (some (.struct "void")), body := [] }],
...
def tri_sort_counting_sort_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "sort", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }],
...
def tri_sort_heap_sort_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "sort", params := [("values", (.struct "[]i64"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "sort_basic_case", params := [], ret := none, body := [] }],
  benches := []
}
...
def tri_sort_merge_sort_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "sort", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "sort_in_place", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }],
...
def tri_sort_quick_sort_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "sort", params := [("values", (.struct "[]i64"))], ret := (some (.struct "void")), body := [] }, { name := "sort_range", params := [("values", (.struct "[]i64"))], ret := (some (.struct "void")), body := [] }],
...
def tri_sort_radix_sort_env : Env := {
  structs := [("RadixSorter", [("base", (.struct "usize")), ("max_digits", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_sort_sort_env : Env := {
  structs := [("SortOrder", [("Ascending", (.u32)), ("Descending", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_sort_sort_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "sort", params := [("items", (.struct "[]const T"))], ret := (some (.struct "void")), body := [] }, { name := "sort_by", params := [("items", (.struct "[]const T"))], ret := (some (.struct "void")), body := [] }],
...
def tri_trees_avl_tree_env : Env := {
  structs := [("AVLTree", [("generic", (.struct "K, V")), ("root", (.struct "?*AVLNode")), ("size", (.struct "usize"))]), ("AVLNode", [("generic", (.struct "K, V")), ("key", (.struct "K")), ("value", (.struct "V")), ("height", (.i32)), ("left", (.struct "?*AVLNode")), ("right", (.struct "?*AVLNode"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def tri_trees_avl_tree_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [], ret := (some (.struct "AVLTree")), body := [] }, { name := "insert", params := [("tree", (.struct "*AVLTree"))], ret := (some (.struct "void")), body := [] }, { name := "find", params := [("tree", (.struct "*const AVLTree"))], ret := (some (.struct "void")), body := [] }, { name := "delete", params := [("tree", (.struct "*AVLTree"))], ret := (some (.struct "void")), body := [] }],
...
def tri_trees_b_tree_env : Env := {
  structs := [("BTreeNode", [("keys", (.struct "[[]Usize,
        children : [[]?*BTreeNode")), ("leaf", (.bool)), ("count", (.struct "usize"))]), ("BTree", [("root", (.struct "?*BTreeNode")), ("t", (.struct "usize")), ("allocator", (.struct "std.mem.Allocator"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_trees_b_tree_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "search", params := [("tree", (.struct "*BTree"))], ret := (some (.struct "void")), body := [] }, { name := "insert", params := [("tree", (.struct "*BTree"))], ret := (some (.struct "void")), body := [] }, { name := "deinit", params := [("tree", (.struct "*BTree"))], ret := (some (.struct "void")), body := [] }],
...
def tri_trees_octree_env : Env := {
  structs := [("BBox", [("min_x", (.struct "f64")), ("min_y", (.struct "f64")), ("min_z", (.struct "f64")), ("max_x", (.struct "f64")), ("max_y", (.struct "f64")), ("max_z", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_trees_quadtree_env : Env := {
  structs := [("Rect", [("x", (.struct "f64")), ("y", (.struct "f64")), ("width", (.struct "f64")), ("height", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_trees_red_black_tree_env : Env := {
  structs := [("RBTree", [("generic", (.struct "K, V")), ("root", (.struct "?*RBNode")), ("size", (.struct "usize"))]), ("RBNode", [("generic", (.struct "K, V")), ("key", (.struct "K")), ("value", (.struct "V")), ("color", (.struct "Color")), ("left", (.struct "?*RBNode")), ("right", (.struct "?*RBNode")), ("parent", (.struct "?*RBNode"))]), ("Color", []), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def tri_trees_red_black_tree_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [], ret := (some (.struct "RBTree")), body := [] }, { name := "insert", params := [("tree", (.struct "*RBTree"))], ret := (some (.struct "void")), body := [] }, { name := "find", params := [("tree", (.struct "*const RBTree"))], ret := (some (.struct "void")), body := [] }, { name := "delete", params := [("tree", (.struct "*RBTree"))], ret := (some (.struct "void")), body := [] }],
  tests := [{ name := "init_basic_case", params := [], ret := none, body := [] }, { name := "insert_basic_case", params := [], ret := none, body := [] }, { name := "find_basic_case", params := [], ret := none, body := [] }, { name := "delete_basic_case", params := [], ret := none, body := [] }],
  benches := []
}

def tri_trees_rtree_env : Env := {
  structs := [("Rect", [("x_min", (.struct "f64")), ("y_min", (.struct "f64")), ("x_max", (.struct "f64")), ("y_max", (.struct "f64"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_trees_splay_tree_env : Env := {
  structs := [("SplayTree", [("generic", (.struct "K, V")), ("root", (.struct "?*SplayNode")), ("size", (.struct "usize"))]), ("SplayNode", [("generic", (.struct "K, V")), ("key", (.struct "K")), ("value", (.struct "V")), ("left", (.struct "?*SplayNode")), ("right", (.struct "?*SplayNode")), ("parent", (.struct "?*SplayNode"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def tri_trees_splay_tree_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [], ret := (some (.struct "SplayTree")), body := [] }, { name := "find", params := [("tree", (.struct "*SplayTree"))], ret := (some (.struct "void")), body := [] }, { name := "insert", params := [("tree", (.struct "*SplayTree"))], ret := (some (.struct "void")), body := [] }, { name := "delete", params := [("tree", (.struct "*SplayTree"))], ret := (some (.struct "void")), body := [] }],
...
def tri_trees_tree_env : Env := {
  structs := [("", [("is_leaf", (.bool)), ("value", (.struct "T")), ("left", (.struct "Tree(T)")), ("right", (.struct "Tree(T)"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_trees_trie_env : Env := {
  structs := [("", [("is_end", (.bool)), ("value", (.struct "T")), ("children", (.struct "std.StringHashMap(*TrieNode(T))"))]), ("", [("root", (.struct "*TrieNode(T)")), ("size", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_utils_args_env : Env := {
  structs := [("Arg", [("short", (.u8)), ("long", (.struct "[]constu8")), ("required", (.bool))]), ("ArgValue", [("value", (.struct "[]constu8")), ("present", (.bool))]), ("ParseResult", [("positional", (.struct "[][]constu8")), ("named", (.struct "[]ArgValue")), ("error", (.struct "[]constu8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_utils_color_env : Env := {
  structs := [("Color", [("r", (.u8)), ("g", (.u8)), ("b", (.u8)), ("a", (.u8))]), ("ColorSpace", [("RGB", (.u32)), ("HSV", (.u32)), ("HSL", (.u32)), ("LAB", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_utils_color_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "rgb", params := [("r", (.u8))], ret := (some (.struct "void")), body := [] }, { name := "to_hex", params := [("color", (.struct "Color"))], ret := (some (.struct "void")), body := [] }, { name := "blend", params := [("a", (.struct "Color"))], ret := (some (.struct "void")), body := [] }],
...
def tri_utils_config_env : Env := {
  structs := [("ConfigValue", [("string", (.struct "[]constu8")), ("number", (.struct "f64")), ("boolean", (.bool)), ("is_null", (.bool))]), ("ConfigEntry", [("key", (.struct "[]constu8")), ("value", (.struct "ConfigValue"))]), ("Config", [("entries", (.struct "[]ConfigEntry")), ("error", (.struct "[]constu8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_utils_config_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "parse", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "get_string", params := [("config", (.struct "Config"))], ret := (some (.struct "void")), body := [] }, { name := "get_number", params := [("config", (.struct "Config"))], ret := (some (.struct "void")), body := [] }, { name := "get_bool", params := [("config", (.struct "Config"))], ret := (some (.struct "void")), body := [] }],
...
def tri_utils_error_env : Env := {
  structs := [("TriError", []), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_utils_exit_codes_env : Env := {
  structs := [("ExitCode", [("kind", (.struct "Enum(u8)")), ("variants", (.u32)), ("success", (.struct "0")), ("command_error", (.struct "1")), ("validation_error", (.struct "2")), ("runtime_error", (.struct "3")), ("timeout", (.struct "4")), ("job_failed", (.struct "5")), ("artifact_failed", (.struct "6")), ("internal_error", (.struct "7"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_utils_help_env : Env := {
  structs := [("HelpOptions", [("category", (.struct "CommandCategorydefault:null")), ("search", (.struct "[]constU8default:null")), ("verbose", (.struct "Booldefault:false"))]), ("HelpSystem", [("registry", (.struct "*constCommandRegistry")), ("allocator", (.struct "Std.mem.Allocator")), ("terminal_width", (.struct "Usizedefault:80"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_utils_logging_env : Env := {
  structs := [("LogLevel", []), ("LogEntry", [("level", (.struct "LogLevel")), ("message", (.struct "[]constu8")), ("timestamp", (.u64)), ("tag", (.struct "[]constu8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_utils_random_env : Env := {
  structs := [("Rng", [("state", (.u64))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_utils_random_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "init", params := [("seed", (.u64))], ret := (some (.struct "void")), body := [] }, { name := "next", params := [("rng", (.struct "*Rng"))], ret := (some (.struct "void")), body := [] }, { name := "range", params := [("rng", (.struct "*Rng"))], ret := (some (.struct "void")), body := [] }, { name := "range_inclusive", params := [("rng", (.struct "*Rng"))], ret := (some (.struct "void")), body := [] }],
...
def tri_utils_terminal_env : Env := {
  structs := [("Color", []), ("Style", []), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_utils_terminal_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "get_size", params := [], ret := (some (.struct "TerminalSize")), body := [] }, { name := "colorize", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "reset", params := [], ret := (some (.struct "[]const u8")), body := [] }],
...
def tri_utils_text_env : Env := {
  structs := [("TextMetrics", [("width", (.struct "usize")), ("height", (.struct "usize")), ("lines", (.struct "usize"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_utils_text_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "word_wrap", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }, { name := "count_words", params := [("text", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "count_lines", params := [("text", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "indent", params := [("allocator", (.struct "Std")), ("mem", (.u32)), ("Allocator", (.u32))], ret := (some (.struct "void")), body := [] }],
...
def tri_utils_time_env : Env := {
  structs := [("Instant", [("epoch_seconds", (.i64)), ("nanos", (.u32))]), ("Duration", [("seconds", (.i64)), ("nanos", (.u32))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
...
def tri_utils_time_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "now", params := [], ret := (some (.struct "Instant")), body := [] }, { name := "since_epoch", params := [("instant", (.struct "Instant"))], ret := (some (.struct "void")), body := [] }, { name := "add", params := [("instant", (.struct "Instant"))], ret := (some (.struct "void")), body := [] }, { name := "sub", params := [("a", (.struct "Instant"))], ret := (some (.struct "void")), body := [] }, { name := "format", params := [("instant", (.struct "Instant"))], ret := (some (.struct "void")), body := [] }],
...
def tri_utils_utf8_env : Env := {
  structs := [("Codepoint", [("underlying", (.struct "u21"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("types", ("base::types", "types")), ("constants", ("math::constants", "constants"))],
  hostOnly := [],
...
def tri_utils_version_env : Env := {
  structs := [("Version", [("major", (.struct "usize")), ("minor", (.struct "usize")), ("patch", (.struct "usize")), ("prerelease", (.struct "[[]Constu8,
        build : [[]Const u8"))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))])],
  constructors := [],
  enums := [],
  imports := [("constants", ("math::constants", "constants")), ("types", ("base::types", "types"))],
  hostOnly := [],
...
def tri_utils_version_module : Module := {
  ...
  imports := [{ path := "base::types", items := ["types"] }, { path := "math::constants", items := ["constants"] }],
  globals := [],
  functions := [{ name := "parse", params := [("version_str", (.struct "[]const u8"))], ret := (some (.struct "void")), body := [] }, { name := "compare", params := [("a", (.struct "Version"))], ret := (some (.struct "void")), body := [] }, { name := "next", params := [("version", (.struct "Version"))], ret := (some (.struct "void")), body := [] }],
...
def vm_jit_semantics_env : Env := {
  structs := [("JitCompiler", [("code_buffer", (.struct "[]u8")), ("allocator_id", (.u16)), ("exec_memory", (.struct "[]u8"))]), ("JitCache", [("bind_cache", (.struct "map<usize")), ("JitVsaFn", (.u32)), ("compiler", (.struct "JitCompiler")), ("allocator_id", (.u16))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("HybridArithmetic::HybridBigInt", [("packed_data", (.struct "[]u8")), ("unpacked_data", (.struct "[]i8")), ("mode", (.struct "StorageMode")), ("sign", (.i8)), ("trit_count", (.u16))]), ("HybridArithmetic::Vec32i8", [("data", (.array 32 (.i8)))]), ("HybridArithmetic::Vec32i16", [("data", (.array 16 (.i16)))])],
  constructors := [],
  enums := ["VsaOperation"],
...
def vsa_packed_vsa_env : Env := {
  structs := [("HybridArithmetic::Vec32i8", [("data", (.array 32 (.i8)))]), ("PackedTrit::PackResult", [("bytes", (.struct "[]u8")), ("count", (.u16)), ("valid", (.bool))]), ("HybridArithmetic::HybridBigInt", [("packed_data", (.struct "[]u8")), ("unpacked_data", (.struct "[]i8")), ("mode", (.struct "StorageMode")), ("sign", (.i8)), ("trit_count", (.u16))]), ("PackedTrit::ArithResult", [("value", (.struct "PackedBigInt")), ("overflow", (.bool))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("HybridArithmetic::Vec32i16", [("data", (.array 16 (.i16)))]), ("PackedTrit::PackedBigInt", [("data", (.struct "[]u8")), ("sign", (.i8)), ("magnitude", (.u16))]), ("PackedTrit::UnpackResult", [("trits", (.struct "[]i8")), ("count", (.u16)), ("valid", (.bool))])],
  constructors := [],
  enums := [],
...
def vsa_sequence_hdc_env : Env := {
  structs := [("ItemMemory", [("allocator_id", (.u16)), ("dimension", (.struct "usize")), ("seed", (.u64)), ("cache", (.struct "map<u32")), ("PackedBigInt", (.u32))]), ("NGramEncoder", [("item_memory", (.struct "*ItemMemory")), ("jit_enabled", (.bool))]), ("SequenceMemory", [("allocator_id", (.u16)), ("n", (.u16)), ("item_memory", (.struct "*ItemMemory")), ("sequences", (.struct "map<u64")), ("PackedBigInt", (.u32)), ("jit_enabled", (.bool))]), ("EncodedSequence", [("label", (.struct "[]constu8")), ("vector", (.struct "PackedBigInt"))]), ("QueryResult", [("label", (.struct "[]constu8")), ("similarity", (.struct "f64"))]), ("PackedTrit::PackResult", [("bytes", (.struct "[]u8")), ("count", (.u16)), ("valid", (.bool))]), ("PackedTrit::UnpackResult", [("trits", (.struct "[]i8")), ("count", (.u16)), ("valid", (.bool))]), ("PackedTrit::PackedBigInt", [("data", (.struct "[]u8")), ("sign", (.i8)), ("magnitude", (.u16))]), ("tritype-base::UnpackResult", [("value", (.struct "Trit")), ("valid", (.bool))]), ("PackedTrit::ArithResult", [("value", (.struct "PackedBigInt")), ("overflow", (.bool))])],
  constructors := [],
  enums := [],
...
theorem base_ternary_encoding_lowerable : Module.isLowerable base_ternary_encoding_env base_ternary_encoding_module = true := by native_decide
theorem base_ternary_memory_lowerable : Module.isLowerable base_ternary_memory_env base_ternary_memory_module = true := by native_decide
...
theorem benchmarks_bench_nn_lowerable : Module.isLowerable benchmarks_bench_nn_env benchmarks_bench_nn_module = true := by native_decide
...
theorem config_load_lowerable : Module.isLowerable config_load_env config_load_module = true := by native_decide
...
theorem fpga_bootrom_lowerable : Module.isLowerable fpga_bootrom_env fpga_bootrom_module = true := by native_decide
theorem fpga_cts_lowerable : Module.isLowerable fpga_cts_env fpga_cts_module = true := by native_decide
theorem fpga_dft_lowerable : Module.isLowerable fpga_dft_env fpga_dft_module = true := by native_decide
theorem fpga_hw_types_lowerable : Module.isLowerable fpga_hw_types_env fpga_hw_types_module = true := by native_decide
theorem fpga_mac_lowerable : Module.isLowerable fpga_mac_env fpga_mac_module = true := by native_decide
theorem fpga_power_lowerable : Module.isLowerable fpga_power_env fpga_power_module = true := by native_decide
theorem fpga_spi_lowerable : Module.isLowerable fpga_spi_env fpga_spi_module = true := by native_decide
theorem fpga_top_level_lowerable : Module.isLowerable fpga_top_level_env fpga_top_level_module = true := by native_decide
theorem fpga_uart_lowerable : Module.isLowerable fpga_uart_env fpga_uart_module = true := by native_decide
theorem fpga_verification_build_verify_lowerable : Module.isLowerable fpga_verification_build_verify_env fpga_verification_build_verify_module = true := by native_decide
...
theorem graph_knowledge_graph_lowerable : Module.isLowerable graph_knowledge_graph_env graph_knowledge_graph_module = true := by native_decide
theorem hslm_forward_pass_lowerable : Module.isLowerable hslm_forward_pass_env hslm_forward_pass_module = true := by native_decide
...
theorem igla_race_systolic_ternary_lowerable : Module.isLowerable igla_race_systolic_ternary_env igla_race_systolic_ternary_module = true := by native_decide
theorem igla_race_ternary_inference_lowerable : Module.isLowerable igla_race_ternary_inference_env igla_race_ternary_inference_module = true := by native_decide
theorem igla_race_ternary_mac_lowerable : Module.isLowerable igla_race_ternary_mac_env igla_race_ternary_mac_module = true := by native_decide
...
theorem isa_ternary_gates_lowerable : Module.isLowerable isa_ternary_gates_env isa_ternary_gates_module = true := by native_decide
...
theorem ml_layers_conv2d_layer_lowerable : Module.isLowerable ml_layers_conv2d_layer_env ml_layers_conv2d_layer_module = true := by native_decide
theorem ml_layers_dense_layer_lowerable : Module.isLowerable ml_layers_dense_layer_env ml_layers_dense_layer_module = true := by native_decide
theorem ml_layers_embedding_layer_lowerable : Module.isLowerable ml_layers_embedding_layer_env ml_layers_embedding_layer_module = true := by native_decide
theorem ml_layers_flatten_layer_lowerable : Module.isLowerable ml_layers_flatten_layer_env ml_layers_flatten_layer_module = true := by native_decide
theorem ml_layers_maxpool2d_layer_lowerable : Module.isLowerable ml_layers_maxpool2d_layer_env ml_layers_maxpool2d_layer_module = true := by native_decide
theorem ml_layers_residual_connection_lowerable : Module.isLowerable ml_layers_residual_connection_env ml_layers_residual_connection_module = true := by native_decide
theorem ml_loss_kl_divergence_lowerable : Module.isLowerable ml_loss_kl_divergence_env ml_loss_kl_divergence_module = true := by native_decide
theorem ml_loss_mse_loss_lowerable : Module.isLowerable ml_loss_mse_loss_env ml_loss_mse_loss_module = true := by native_decide
theorem ml_optimizer_lr_scheduler_lowerable : Module.isLowerable ml_optimizer_lr_scheduler_env ml_optimizer_lr_scheduler_module = true := by native_decide
theorem ml_optimizer_sgd_momentum_lowerable : Module.isLowerable ml_optimizer_sgd_momentum_env ml_optimizer_sgd_momentum_module = true := by native_decide
theorem ml_pathway_mlp_lowerable : Module.isLowerable ml_pathway_mlp_env ml_pathway_mlp_module = true := by native_decide
theorem ml_recurrent_bilstm_lowerable : Module.isLowerable ml_recurrent_bilstm_env ml_recurrent_bilstm_module = true := by native_decide
theorem ml_recurrent_gru_cell_lowerable : Module.isLowerable ml_recurrent_gru_cell_env ml_recurrent_gru_cell_module = true := by native_decide
theorem ml_recurrent_lstm_cell_lowerable : Module.isLowerable ml_recurrent_lstm_cell_env ml_recurrent_lstm_cell_module = true := by native_decide
theorem ml_recurrent_rnn_cell_lowerable : Module.isLowerable ml_recurrent_rnn_cell_env ml_recurrent_rnn_cell_module = true := by native_decide
theorem ml_recurrent_self_attention_lowerable : Module.isLowerable ml_recurrent_self_attention_env ml_recurrent_self_attention_module = true := by native_decide
theorem ml_recurrent_seq2seq_lowerable : Module.isLowerable ml_recurrent_seq2seq_env ml_recurrent_seq2seq_module = true := by native_decide
theorem ml_rl_ppo_critic_lowerable : Module.isLowerable ml_rl_ppo_critic_env ml_rl_ppo_critic_module = true := by native_decide
theorem ml_transformer_feed_forward_network_lowerable : Module.isLowerable ml_transformer_feed_forward_network_env ml_transformer_feed_forward_network_module = true := by native_decide
theorem ml_transformer_multi_head_attention_lowerable : Module.isLowerable ml_transformer_multi_head_attention_env ml_transformer_multi_head_attention_module = true := by native_decide
theorem ml_transformer_positional_encoding_lowerable : Module.isLowerable ml_transformer_positional_encoding_env ml_transformer_positional_encoding_module = true := by native_decide
...
theorem numeric_bigint_lowerable : Module.isLowerable numeric_bigint_env numeric_bigint_module = true := by native_decide
theorem numeric_formats_lowerable : Module.isLowerable numeric_formats_env numeric_formats_module = true := by native_decide
theorem numeric_gf_competitive_lowerable : Module.isLowerable numeric_gf_competitive_env numeric_gf_competitive_module = true := by native_decide
theorem numeric_pellis_verify_lowerable : Module.isLowerable numeric_pellis_verify_env numeric_pellis_verify_module = true := by native_decide
...
theorem physics_su2_chern_simons_lowerable : Module.isLowerable physics_su2_chern_simons_env physics_su2_chern_simons_module = true := by native_decide
...
theorem runtime_instance_lowerable : Module.isLowerable runtime_instance_env runtime_instance_module = true := by native_decide
...
theorem sacred_sacred_constants_lowerable : Module.isLowerable sacred_sacred_constants_env sacred_sacred_constants_module = true := by native_decide
theorem sacred_sacred_governance_lowerable : Module.isLowerable sacred_sacred_governance_env sacred_sacred_governance_module = true := by native_decide
theorem sacred_sacred_identity_lowerable : Module.isLowerable sacred_sacred_identity_env sacred_sacred_identity_module = true := by native_decide
...
theorem sync_index_lowerable : Module.isLowerable sync_index_env sync_index_module = true := by native_decide
...
theorem tri_agent_autonomous_lifecycle_lowerable : Module.isLowerable tri_agent_autonomous_lifecycle_env tri_agent_autonomous_lifecycle_module = true := by native_decide
...
theorem tri_agent_governance_agent_lowerable : Module.isLowerable tri_agent_governance_agent_env tri_agent_governance_agent_module = true := by native_decide
theorem tri_agent_handoff_lowerable : Module.isLowerable tri_agent_handoff_env tri_agent_handoff_module = true := by native_decide
theorem tri_agent_memory_lowerable : Module.isLowerable tri_agent_memory_env tri_agent_memory_module = true := by native_decide
theorem tri_agent_swarm_agents_lowerable : Module.isLowerable tri_agent_swarm_agents_env tri_agent_swarm_agents_module = true := by native_decide
...
theorem tri_collections_linked_list_lowerable : Module.isLowerable tri_collections_linked_list_env tri_collections_linked_list_module = true := by native_decide
...
theorem tri_collections_lockfree_stack_lowerable : Module.isLowerable tri_collections_lockfree_stack_env tri_collections_lockfree_stack_module = true := by native_decide
...
theorem tri_collections_lru_cache_lowerable : Module.isLowerable tri_collections_lru_cache_env tri_collections_lru_cache_module = true := by native_decide
...
theorem tri_collections_namespace_lowerable : Module.isLowerable tri_collections_namespace_env tri_collections_namespace_module = true := by native_decide
...
theorem tri_crypto_crypto_lowerable : Module.isLowerable tri_crypto_crypto_env tri_crypto_crypto_module = true := by native_decide
theorem tri_crypto_ecc_lowerable : Module.isLowerable tri_crypto_ecc_env tri_crypto_ecc_module = true := by native_decide
theorem tri_crypto_hmac_lowerable : Module.isLowerable tri_crypto_hmac_env tri_crypto_hmac_module = true := by native_decide
theorem tri_crypto_reed_solomon_lowerable : Module.isLowerable tri_crypto_reed_solomon_env tri_crypto_reed_solomon_module = true := by native_decide
theorem tri_crypto_rsa_lowerable : Module.isLowerable tri_crypto_rsa_env tri_crypto_rsa_module = true := by native_decide
theorem tri_encoding_bson_lowerable : Module.isLowerable tri_encoding_bson_env tri_encoding_bson_module = true := by native_decide
theorem tri_encoding_csv_lowerable : Module.isLowerable tri_encoding_csv_env tri_encoding_csv_module = true := by native_decide
theorem tri_encoding_html_lowerable : Module.isLowerable tri_encoding_html_env tri_encoding_html_module = true := by native_decide
theorem tri_encoding_json_lowerable : Module.isLowerable tri_encoding_json_env tri_encoding_json_module = true := by native_decide
...
theorem tri_encoding_xml_lowerable : Module.isLowerable tri_encoding_xml_env tri_encoding_xml_module = true := by native_decide
theorem tri_graph_dijkstra_lowerable : Module.isLowerable tri_graph_dijkstra_env tri_graph_dijkstra_module = true := by native_decide
theorem tri_graph_graph_lowerable : Module.isLowerable tri_graph_graph_env tri_graph_graph_module = true := by native_decide
theorem tri_graph_graph_bfs_lowerable : Module.isLowerable tri_graph_graph_bfs_env tri_graph_graph_bfs_module = true := by native_decide
theorem tri_graph_graph_dfs_lowerable : Module.isLowerable tri_graph_graph_dfs_env tri_graph_graph_dfs_module = true := by native_decide
...
theorem tri_io_filesystem_lowerable : Module.isLowerable tri_io_filesystem_env tri_io_filesystem_module = true := by native_decide
theorem tri_io_fs_lowerable : Module.isLowerable tri_io_fs_env tri_io_fs_module = true := by native_decide
theorem tri_io_zip_lowerable : Module.isLowerable tri_io_zip_env tri_io_zip_module = true := by native_decide
theorem tri_math_bezier_lowerable : Module.isLowerable tri_math_bezier_env tri_math_bezier_module = true := by native_decide
theorem tri_math_constants_lowerable : Module.isLowerable tri_math_constants_env tri_math_constants_module = true := by native_decide
...
theorem tri_math_probability_lowerable : Module.isLowerable tri_math_probability_env tri_math_probability_module = true := by native_decide
theorem tri_math_statistics_lowerable : Module.isLowerable tri_math_statistics_env tri_math_statistics_module = true := by native_decide
...
theorem tri_net_http_lowerable : Module.isLowerable tri_net_http_env tri_net_http_module = true := by native_decide
theorem tri_net_net_lowerable : Module.isLowerable tri_net_net_env tri_net_net_module = true := by native_decide
theorem tri_net_url_lowerable : Module.isLowerable tri_net_url_env tri_net_url_module = true := by native_decide
theorem tri_pipeline_batch_runner_lowerable : Module.isLowerable tri_pipeline_batch_runner_env tri_pipeline_batch_runner_module = true := by native_decide
...
theorem tri_pipeline_codegen_lowerable : Module.isLowerable tri_pipeline_codegen_env tri_pipeline_codegen_module = true := by native_decide
...
theorem tri_pipeline_pipeline_parallel_lowerable : Module.isLowerable tri_pipeline_pipeline_parallel_env tri_pipeline_pipeline_parallel_module = true := by native_decide
...
theorem tri_pipeline_workflow_lowerable : Module.isLowerable tri_pipeline_workflow_env tri_pipeline_workflow_module = true := by native_decide
...
theorem tri_search_knuth_morris_pratt_lowerable : Module.isLowerable tri_search_knuth_morris_pratt_env tri_search_knuth_morris_pratt_module = true := by native_decide
theorem tri_search_match_lowerable : Module.isLowerable tri_search_match_env tri_search_match_module = true := by native_decide
theorem tri_search_pattern_lowerable : Module.isLowerable tri_search_pattern_env tri_search_pattern_module = true := by native_decide
theorem tri_search_rabin_karp_lowerable : Module.isLowerable tri_search_rabin_karp_env tri_search_rabin_karp_module = true := by native_decide
theorem tri_search_regex_lowerable : Module.isLowerable tri_search_regex_env tri_search_regex_module = true := by native_decide
theorem tri_search_regex_advanced_lowerable : Module.isLowerable tri_search_regex_advanced_env tri_search_regex_advanced_module = true := by native_decide
theorem tri_search_search_lowerable : Module.isLowerable tri_search_search_env tri_search_search_module = true := by native_decide
theorem tri_sort_counting_sort_lowerable : Module.isLowerable tri_sort_counting_sort_env tri_sort_counting_sort_module = true := by native_decide
theorem tri_sort_heap_sort_lowerable : Module.isLowerable tri_sort_heap_sort_env tri_sort_heap_sort_module = true := by native_decide
theorem tri_sort_insertion_sort_lowerable : Module.isLowerable tri_sort_insertion_sort_env tri_sort_insertion_sort_module = true := by native_decide
theorem tri_sort_merge_sort_lowerable : Module.isLowerable tri_sort_merge_sort_env tri_sort_merge_sort_module = true := by native_decide
theorem tri_sort_quick_sort_lowerable : Module.isLowerable tri_sort_quick_sort_env tri_sort_quick_sort_module = true := by native_decide
theorem tri_sort_radix_sort_lowerable : Module.isLowerable tri_sort_radix_sort_env tri_sort_radix_sort_module = true := by native_decide
theorem tri_sort_selection_sort_lowerable : Module.isLowerable tri_sort_selection_sort_env tri_sort_selection_sort_module = true := by native_decide
theorem tri_sort_shell_sort_lowerable : Module.isLowerable tri_sort_shell_sort_env tri_sort_shell_sort_module = true := by native_decide
theorem tri_sort_sort_lowerable : Module.isLowerable tri_sort_sort_env tri_sort_sort_module = true := by native_decide
theorem tri_sort_tim_sort_lowerable : Module.isLowerable tri_sort_tim_sort_env tri_sort_tim_sort_module = true := by native_decide
theorem tri_trees_avl_tree_lowerable : Module.isLowerable tri_trees_avl_tree_env tri_trees_avl_tree_module = true := by native_decide
theorem tri_trees_b_tree_lowerable : Module.isLowerable tri_trees_b_tree_env tri_trees_b_tree_module = true := by native_decide
...
theorem tri_trees_octree_lowerable : Module.isLowerable tri_trees_octree_env tri_trees_octree_module = true := by native_decide
theorem tri_trees_quadtree_lowerable : Module.isLowerable tri_trees_quadtree_env tri_trees_quadtree_module = true := by native_decide
theorem tri_trees_red_black_tree_lowerable : Module.isLowerable tri_trees_red_black_tree_env tri_trees_red_black_tree_module = true := by native_decide
theorem tri_trees_rtree_lowerable : Module.isLowerable tri_trees_rtree_env tri_trees_rtree_module = true := by native_decide
...
theorem tri_trees_splay_tree_lowerable : Module.isLowerable tri_trees_splay_tree_env tri_trees_splay_tree_module = true := by native_decide
...
theorem tri_utils_color_lowerable : Module.isLowerable tri_utils_color_env tri_utils_color_module = true := by native_decide
theorem tri_utils_colors_lowerable : Module.isLowerable tri_utils_colors_env tri_utils_colors_module = true := by native_decide
theorem tri_utils_config_lowerable : Module.isLowerable tri_utils_config_env tri_utils_config_module = true := by native_decide
theorem tri_utils_error_lowerable : Module.isLowerable tri_utils_error_env tri_utils_error_module = true := by native_decide
theorem tri_utils_exit_codes_lowerable : Module.isLowerable tri_utils_exit_codes_env tri_utils_exit_codes_module = true := by native_decide
theorem tri_utils_help_lowerable : Module.isLowerable tri_utils_help_env tri_utils_help_module = true := by native_decide
theorem tri_utils_logging_lowerable : Module.isLowerable tri_utils_logging_env tri_utils_logging_module = true := by native_decide
theorem tri_utils_random_lowerable : Module.isLowerable tri_utils_random_env tri_utils_random_module = true := by native_decide
...
theorem tri_utils_terminal_lowerable : Module.isLowerable tri_utils_terminal_env tri_utils_terminal_module = true := by native_decide
theorem tri_utils_text_lowerable : Module.isLowerable tri_utils_text_env tri_utils_text_module = true := by native_decide
theorem tri_utils_time_lowerable : Module.isLowerable tri_utils_time_env tri_utils_time_module = true := by native_decide
theorem tri_utils_utf8_lowerable : Module.isLowerable tri_utils_utf8_env tri_utils_utf8_module = true := by native_decide
theorem tri_utils_version_lowerable : Module.isLowerable tri_utils_version_env tri_utils_version_module = true := by native_decide
