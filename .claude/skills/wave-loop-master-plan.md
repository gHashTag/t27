...
| **871** | **#1690 (expected)** | **wave-loop-871 (planned)** | **561** | **280** | **35,904** | **1,148,928** | **1.096** | **in progress** | **TBD** |
| 872 | #1692 (expected) | wave-loop-872 (planned) | 563 | 281 | 36,032 | 1,153,024 | 1.100 | planned | TBD |

### W871 cooperation variants (draft)
