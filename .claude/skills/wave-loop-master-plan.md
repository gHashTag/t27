...
| **870** | **#1688 (expected)** | **wave-loop-870 (planned)** | **559** | **279** | **35,776** | **1,144,832** | **1.092** | **in progress** | **TBD** |
| 871 | #1690 (expected) | wave-loop-871 (planned) | 561 | 280 | 35,904 | 1,148,928 | 1.096 | planned | TBD |

### W870 cooperation variants (draft)
