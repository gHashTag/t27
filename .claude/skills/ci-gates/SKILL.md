...
## 387. A ledger that is entirely stale is stronger emptied than held
...
## 388. Two ways to be false by construction, and the second needs its own test
...
## 389. A pathspec resolves against the current directory
