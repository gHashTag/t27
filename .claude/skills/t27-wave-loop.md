...
| **Parent branch** | `wave-loop-811` HEAD because earlier wave PRs remain open |
| **Recommended variant** | A — module-scope `[443][2]^6 Pt` packed array-of-struct variable from call with indexed signed writes |
| **Status** | READY TO START |
| **Next wave variants queued** | W813 Variant A `[445][2]^6 Pt`; Variant B `[443][3]^6 Pt` stride scaling; Variant C `[443][2]^6 Pt` negative-index wrap-around |
