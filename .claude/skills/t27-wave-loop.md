...
| **Parent branch** | `wave-loop-809` HEAD because earlier wave PRs remain open |
| **Recommended variant** | A — module-scope `[439][2]^6 Pt` packed array-of-struct variable from call with indexed signed writes |
| **Status** | READY TO START |
| **Next wave variants queued** | W811 Variant A `[441][2]^6 Pt`; Variant B `[439][3]^6 Pt` stride scaling; Variant C `[439][2]^6 Pt` negative-index wrap-around |
