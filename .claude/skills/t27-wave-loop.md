...
|-------|-------|
| **Current wave** | 804 |
| **Issue** | TBD (open after W803 PR lands or during W804 setup) |
| **Branch** | `wave-loop-804` |
| **Parent branch** | `wave-loop-803` HEAD because earlier wave PRs remain open |
| **Recommended variant** | A — module-scope `[427][2]^6 Pt` packed array-of-struct variable from call with indexed signed writes |
| **Status** | READY TO START |
| **Next wave variants queued** | W805 Variant A `[429][2]^6 Pt`; Variant B `[425][3]^6 Pt` stride scaling; Variant C `[425][2]^6 Pt` negative-index wrap-around |
