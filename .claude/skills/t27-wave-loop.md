...
|-------|-------|
| **Current wave** | 805 |
| **Issue** | TBD (open after W804 PR lands or during W805 setup) |
| **Branch** | `wave-loop-805` |
| **Parent branch** | `wave-loop-804` HEAD because earlier wave PRs remain open |
| **Recommended variant** | A — module-scope `[429][2]^6 Pt` packed array-of-struct variable from call with indexed signed writes |
| **Status** | READY TO START |
| **Next wave variants queued** | W806 Variant A `[431][2]^6 Pt`; Variant B `[425][3]^6 Pt` stride scaling; Variant C `[425][2]^6 Pt` negative-index wrap-around |
