...
| **Parent branch** | `wave-loop-810` HEAD because earlier wave PRs remain open |
| **Recommended variant** | A — module-scope `[441][2]^6 Pt` packed array-of-struct variable from call with indexed signed writes |
| **Status** | READY TO START |
| **Next wave variants queued** | W812 Variant A `[443][2]^6 Pt`; Variant B `[441][3]^6 Pt` stride scaling; Variant C `[441][2]^6 Pt` negative-index wrap-around |
